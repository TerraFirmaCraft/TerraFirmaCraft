...
public class BuiltinFoods extends DataManagerProvider<FoodDefinition> implements Accessors
{
    ...
    protected void addData(HolderLookup.Provider provider)
    {
        ...
        add(Food.BARLEY, ofDecay(2));
        add(Food.BARLEY_GRAIN, ofFood(0.5f, 0, 0.25f));
        add(Food.BARLEY_FLOUR, ofDecay(0.5f));
        add(Food.BARLEY_DOUGH, ofDecay(3));
        add(Food.BARLEY_BREAD, ofFood(1, 0, 1).grain(1.5f));
        add(Food.BARLEY_BREAD_SANDWICH, EMPTY);
        add(Food.BARLEY_BREAD_JAM_SANDWICH, EMPTY);
        add(Food.MAIZE, ofDecay(2));
        add(Food.MAIZE_GRAIN, ofFood(0.5f, 0, 0.25f));
        add(Food.MAIZE_FLOUR, ofDecay(0.5f));
        add(Food.MAIZE_DOUGH, ofDecay(3));
        add(Food.MAIZE_BREAD, ofFood(1, 0, 1).grain(1f));
        add(Food.MAIZE_BREAD_SANDWICH, EMPTY);
        add(Food.MAIZE_BREAD_JAM_SANDWICH, EMPTY);
        add(Food.OAT, ofDecay(2));
        add(Food.OAT_GRAIN, ofFood(0.5f, 0, 0.25f));
        add(Food.OAT_FLOUR, ofDecay(0.5f));
        add(Food.OAT_DOUGH, ofDecay(3));
        add(Food.OAT_BREAD, ofFood(1, 0, 1).grain(1f));
        add(Food.OAT_BREAD_SANDWICH, EMPTY);
        add(Food.OAT_BREAD_JAM_SANDWICH, EMPTY);
        add(Food.RICE, ofDecay(2));
        add(Food.RICE_GRAIN, ofFood(0.5f, 0, 0.25f));
        add(Food.RICE_FLOUR, ofDecay(0.5f));
        add(Food.RICE_DOUGH, ofDecay(3));
        add(Food.RICE_BREAD, ofFood(1, 0, 1).grain(1.5f));
        add(Food.RICE_BREAD_SANDWICH, EMPTY);
        add(Food.RICE_BREAD_JAM_SANDWICH, EMPTY);
        add(Food.COOKED_RICE, ofFood(2, 5, 1).grain(1f));
        add(Food.RYE, ofDecay(2));
        add(Food.RYE_GRAIN, ofFood(0.5f, 0, 0.25f));
        add(Food.RYE_FLOUR, ofDecay(0.5f));
        add(Food.RYE_DOUGH, ofDecay(3));
        add(Food.RYE_BREAD, ofFood(1, 0, 1).grain(1.5f));
        add(Food.RYE_BREAD_SANDWICH, EMPTY);
        add(Food.RYE_BREAD_JAM_SANDWICH, EMPTY);
        add(Food.WHEAT, ofDecay(2));
        add(Food.WHEAT_GRAIN, ofFood(0.5f, 0, 0.25f));
        add(Food.WHEAT_FLOUR, ofDecay(0.5f));
        add(Food.WHEAT_DOUGH, ofDecay(3));
        add(Food.WHEAT_BREAD, ofFood(1, 0, 1).grain(1f));
        add(Food.WHEAT_BREAD_SANDWICH, EMPTY);
        add(Food.WHEAT_BREAD_JAM_SANDWICH, EMPTY);
        ...
        add(Food.BEEF, ofDecay(2).protein(2f));
        add(Food.PORK, ofDecay(2).protein(1.5f));
        add(Food.CHICKEN, ofDecay(3).protein(1.5f));
        add(Food.MUTTON, ofDecay(3).protein(1.5f));
        add(Food.BLUEGILL, ofDecay(3).protein(0.75f));
        add(Food.RAINBOW_TROUT, ofDecay(3).protein(1f));
        add(Food.LAKE_TROUT, ofDecay(3).protein(1f));
        add(Food.LARGEMOUTH_BASS, ofDecay(3).protein(1f));
        add(Food.SMALLMOUTH_BASS, ofDecay(3).protein(1f));
        add(Food.CRAPPIE, ofDecay(3).protein(0.75f));
        add(Food.SALMON, ofDecay(3).protein(1f));
        add(Food.SHELLFISH, ofFood(2, 0, 0, 2).protein(0.5f));
        add(Food.COD, ofDecay(3).protein(1f));
        add(Food.TROPICAL_FISH, ofDecay(3).protein(1f));
        add(Food.BEAR, ofDecay(2).protein(1.5f));
        add(Food.CALAMARI, ofDecay(3).protein(0.5f));
        add(Food.HORSE_MEAT, ofDecay(2).protein(1.5f));
        add(Food.FROG_LEGS, ofDecay(2).protein(1f));
        add(Food.TURTLE, ofDecay(2).protein(1.5f));
        add(Food.PHEASANT, ofDecay(3).protein(1.5f));
        add(Food.GROUSE, ofDecay(3).protein(1.5f));
        add(Food.TURKEY, ofDecay(3).protein(1.5f));
        add(Food.PEAFOWL, ofDecay(3).protein(1.5f));
        add(Food.VENISON, ofDecay(2).protein(1f));
        add(Food.WOLF, ofDecay(3).protein(0.5f));
        add(Food.RABBIT, ofDecay(3).protein(0.5f));
        add(Food.FOX, ofDecay(3).protein(0.5f));
        add(Food.HYENA, ofDecay(3).protein(0.5f));
        add(Food.DUCK, ofDecay(3).protein(0.5f));
        add(Food.QUAIL, ofDecay(3).protein(0.5f));
        add(Food.CHEVON, ofDecay(3).protein(0.5f));
        add(Food.GRAN_FELINE, ofDecay(3).protein(0.5f));
        add(Food.CAMELIDAE, ofDecay(3).protein(0.5f));
        ...
        add(Food.COOKED_TURTLE, ofDecay(2).protein(2.5f));
