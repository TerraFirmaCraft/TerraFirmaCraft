...
public class BuiltinFauna extends DataManagerProvider<Fauna>
{
    ...
    protected void addData(HolderLookup.Provider provider)
    {
        ...
        add(Faunas.FISH.get(Fish.LAKE_TROUT), b -> b.maxTemperature(23).minRainfall(250));
        add(Faunas.FISH.get(Fish.RAINBOW_TROUT), b -> b.maxTemperature(10).minRainfall(150));
        add(Faunas.FISH.get(Fish.LARGEMOUTH_BASS), b -> b.temperature(-14, 20).rainfall(100, 400));
        add(Faunas.FISH.get(Fish.SMALLMOUTH_BASS), b -> b.temperature(-14, 20).rainfall(100, 400));
        ...
        add(Faunas.GRIZZLY_BEAR, b -> b.temperature(-15, 15).minRainfall(200).minForest(ForestType.EDGE));
        add(Faunas.BLACK_BEAR, b -> b.temperature(5, 20).minRainfall(250).minForest(ForestType.EDGE));
        add(Faunas.COUGAR, b -> b.temperature(-10, 21).minRainfall(150));
        add(Faunas.PANTHER, b -> b.temperature(-10, 21).minRainfall(150));
        add(Faunas.LION, b -> b.minTemperature(16).rainfall(50, 300).maxForest(ForestType.EDGE));
        add(Faunas.SABERTOOTH, b -> b.maxTemperature(0).minRainfall(250));
        add(Faunas.TIGER, b -> b.minTemperature(13).minRainfall(100).minForest(ForestType.EDGE));
        add(Faunas.SQUID, b -> b.distanceBelowSeaLevel(15));
        add(Faunas.OCTOPOTEUTHIS, b -> b.maxBrightness(0).distanceBelowSeaLevel(33));
        add(Faunas.PIG, b -> b.temperature(-10, 35).minRainfall(200).minForest(ForestType.EDGE));
        ...
        add(Faunas.CHICKEN, b -> b.minTemperature(14).minRainfall(225).minForest(ForestType.EDGE));
        add(Faunas.DUCK, b -> b.temperature(-25, 30).minRainfall(100).maxForest(ForestType.EDGE));
        add(Faunas.QUAIL, b -> b.temperature(-15, 10).minRainfall(200));
        add(Faunas.RABBIT, b -> b.minRainfall(15));
        add(Faunas.FOX, b -> b.rainfall(130, 400).maxTemperature(25).minForest(ForestType.EDGE));
        add(Faunas.PANDA, b -> b.temperature(18, 28).rainfall(300, 500).minForest(ForestType.NORMAL).fuzzy());
        add(Faunas.BOAR, b -> b.rainfall(130, 400).temperature(-5, 25).maxForest(ForestType.NORMAL));
        add(Faunas.WILDEBEEST, b -> b.rainfall(90, 380).minTemperature(13).maxForest(ForestType.EDGE));
        add(Faunas.OCELOT, b -> b.rainfall(300, 500).temperature(15, 30).minForest(ForestType.EDGE));
        add(Faunas.CARIBOU, b -> b.rainfall(110, 500).maxTemperature(-9));
        add(Faunas.DEER, b -> b.rainfall(160, 500).temperature(-12, 16).minForest(ForestType.EDGE));
        add(Faunas.GAZELLE, b -> b.rainfall(90, 380).minTemperature(12).maxForest(ForestType.EDGE));
        add(Faunas.BONGO, b -> b.rainfall(230, 500).minTemperature(15).minForest(ForestType.EDGE));
        add(Faunas.MOOSE, b -> b.rainfall(150, 300).temperature(-15, 10).minForest(ForestType.EDGE));
        add(Faunas.GROUSE, b -> b.rainfall(150, 400).temperature(-12, 13));
        add(Faunas.PHEASANT, b -> b.rainfall(100, 300).temperature(-5, 17).minForest(ForestType.EDGE));
        add(Faunas.TURKEY, b -> b.rainfall(250, 450).temperature(0, 17).maxForest(ForestType.NORMAL));
        add(Faunas.PEAFOWL, b -> b.rainfall(190, 500).minTemperature(14).minForest(ForestType.NORMAL));
        add(Faunas.WOLF, b -> b.rainfall(150, 420).temperature(-12, 17).maxForest(ForestType.NORMAL));
        add(Faunas.HYENA, b -> b.rainfall(80, 380).minTemperature(15).maxForest(ForestType.NORMAL));
        add(Faunas.DIREWOLF, b -> b.rainfall(150, 420).maxTemperature(-5).maxForest(ForestType.NORMAL));
        add(Faunas.DONKEY, b -> b.rainfall(130, 400).minTemperature(-15).maxForest(ForestType.EDGE));
        add(Faunas.MULE, b -> b.rainfall(130, 400).minTemperature(-15).maxForest(ForestType.EDGE));
        add(Faunas.HORSE, b -> b.rainfall(130, 400).minTemperature(-15).maxForest(ForestType.EDGE));
    }
