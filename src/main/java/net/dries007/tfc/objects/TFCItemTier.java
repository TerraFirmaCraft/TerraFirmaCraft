...
{
    public static final IItemTier IGNEOUS_INTRUSIVE = new TFCItemTier(1, 60, 7, 2.0f, 5); //Tier 0
    ...
    public static final IItemTier COPPER = new TFCItemTier(2, 600, 8, 3.25f, 8); //Tier 1
    public static final IItemTier BRONZE = new TFCItemTier(2, 1300, 11, 5.0f, 13); //Tier 2
    ...
    public static final IItemTier IRON = new TFCItemTier(2, 2200, 12, 6.75f, 10); //Tier 3
    public static final IItemTier STEEL = new TFCItemTier(2, 3300, 14, 8.5f, 10); //Tier 4
    public static final IItemTier BLACK_STEEL = new TFCItemTier(3, 4200, 16, 10.25f, 12); //Tier 5
    public static final IItemTier BLUE_STEEL = new TFCItemTier(3, 6500, 18, 12.0f, 22); //Tier 6
