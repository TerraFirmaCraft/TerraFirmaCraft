...
import net.dries007.tfc.api.IDamageTypeArmor;
...
public final class TFCArmorMaterial implements IArmorMaterial, IDamageTypeArmor
{
    ...
    public static final TFCArmorMaterial BLACK_BRONZE = new TFCArmorMaterial(MOD_ID + ":black_bronze", 21, new int[] {1, 4, 4, 1}, 9, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, () -> Ingredient.EMPTY, 10, 15, 8.25f);
    public static final TFCArmorMaterial BRONZE = new TFCArmorMaterial(MOD_ID + ":bronze", 21, new int[] {1, 4, 4, 1}, 9, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, () -> Ingredient.EMPTY, 12.5f, 12.5f, 8.25f);
    public static final TFCArmorMaterial WROUGHT_IRON = new TFCArmorMaterial(MOD_ID + ":wrought_iron", 33, new int[] {1, 4, 5, 2}, 12, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, () -> Ingredient.EMPTY, 20, 20, 13.2f);
    public static final TFCArmorMaterial STEEL = new TFCArmorMaterial(MOD_ID + ":steel", 40, new int[] {2, 5, 6, 2}, 12, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, () -> Ingredient.EMPTY, 25, 30, 16.5f);
    public static final TFCArmorMaterial BLACK_STEEL = new TFCArmorMaterial(MOD_ID + ":black_steel", 50, new int[] {2, 5, 6, 2}, 17, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, () -> Ingredient.EMPTY, 50, 45, 33);
