...
public class EntitySheepTFC extends EntityAnimalMammal implements IShearable, IAnimalTFC
{
	...
	{
		this(worldIn, Gender.fromBool(Constants.RNG.nextBoolean()), getRandomGrowth(), EntitySheep.getRandomSheepColor(Constants.RNG));
	}
	...
	{
		return (temperature > -20 && temperature < 0 && rainfall > 100) || (temperature > -10 && rainfall > 100 && biome == BiomesTFC.MOUNTAINS);
	}
