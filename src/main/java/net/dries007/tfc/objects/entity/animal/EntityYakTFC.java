...
public class EntityYakTFC extends EntityAnimalMammal implements ILivestock
{
    private static final DataParameter<Long> MILKED = EntityDataManager.createKey(EntityYakTFC.class, Helpers.LONG_DATA_SERIALIZER);
