...
public class EntitySeaLionTFC extends EntityAnimalMammal implements IHuntable
{
    private static final int DAYS_TO_ADULTHOOD = 16;

    @SuppressWarnings("unused")
    public EntitySeaLionTFC(World worldIn)
    {
        this(worldIn, Gender.valueOf(Constants.RNG.nextBoolean()), getRandomGrowth(DAYS_TO_ADULTHOOD, 0));
    }

    public EntitySeaLionTFC(World worldIn, Gender gender, int birthDay)
    {
