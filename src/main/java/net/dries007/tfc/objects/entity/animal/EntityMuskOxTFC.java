...
public class EntityMuskOxTFC extends EntityAnimalMammal implements IShearable, ILivestock
{
    private static final DataParameter<Integer> DYE_COLOR = EntityDataManager.createKey(EntityMuskOxTFC.class, DataSerializers.VARINT);
    private static final DataParameter<Long> SHEARED = EntityDataManager.createKey(EntityMuskOxTFC.class, Helpers.LONG_DATA_SERIALIZER);
