...
public class EntityGrouseTFC extends EntityAnimalTFC implements ILivestock
{
    //The last time(in ticks) this chicken has laid eggs
    private static final DataParameter<Long> LAID = EntityDataManager.createKey(EntityGrouseTFC.class, Helpers.LONG_DATA_SERIALIZER);
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.getClass() == EntityGrouseTFC.class && this.getGender() == Gender.MALE && !this.world.isRemote && !this.isChild() && CalendarTFC.CALENDAR_TIME.getHourOfDay() == 6 && CalendarTFC.CALENDAR_TIME.getMinuteOfHour() == 0)
        {
