...
public class EntityPheasantTFC extends EntityAnimalOviparous implements IAnimalTFC
{
	...
	// Copy from vanilla's EntityChicken, used by renderer to properly handle wing
	// flap
	...
	{
		return (temperature > -10 && temperature < 15 && rainfall > 200) || (temperature > 15 && rainfall > 325);
	}
