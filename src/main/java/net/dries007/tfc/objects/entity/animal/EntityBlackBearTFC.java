...
public class EntityBlackBearTFC extends EntityAnimalMammal implements IPredator, EntityAIStandAttack.IEntityStandAttack
{
    ...
    static
    {
        IS_STANDING = EntityDataManager.createKey(EntityBlackBearTFC.class, DataSerializers.BOOLEAN);
    }
