...
/**
 * This is a {@link IContainerListener} which will monitor containers and send
 * any capability data changes for IForgeable or IItemHeat
 *
 * @author Choonster
...
public class CapabilityContainerListener implements IContainerListener
{
	...
	/**
	 * This is called to send a single slot contents. It uses a modified packet
	 * factory method to accept a capability instance This only gets called when a
	 * slot changes (only non-capability changes count)
	 */
	@Override
