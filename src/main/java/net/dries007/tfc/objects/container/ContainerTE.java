...
public abstract class ContainerTE<T extends TEInventory> extends ContainerSimple
{
	...
	private final int yOffset; // The number of pixels higher than normal (If the gui is larger than normal,
								// see Anvil)
	...
	{
		// Instead of overriding this, consider overriding transferIntoContainer if that
		...
		if (index < containerSlots)
		{
			...
			// This is already called in SlotCallback (which should be used by the Container
			// anyway)
	...
	/**
	 * Helper method for overriding just container insertion priority The method
	 * {@link ContainerTE#transferStackInSlot(EntityPlayer, int)} will search
	 * through slots given by this order. Slots with constrained input should be
	 * first, general purpose slots later in order to have the best shift-click
	 * experience
	 */
