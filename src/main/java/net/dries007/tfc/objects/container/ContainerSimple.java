...
/**
 * A very simple container implementation. Used for gui's that have no internal
 * inventory, or no TE they need to access Prefer using {@link ContainerTE}
 * instead for tile entities or {@link ContainerItemStack} for items
 */
