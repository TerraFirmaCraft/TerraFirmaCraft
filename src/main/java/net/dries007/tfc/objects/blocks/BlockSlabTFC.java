...
public abstract class BlockSlabTFC extends BlockSlab
{
    ...
    private BlockSlabTFC(Rock rock, RockType type)
    {
    ...
    {
        private static final Map<Rock, EnumMap<RockType, Double>> ROCK_TABLE = new HashMap<>();
        private static final Map<Tree, Double> WOOD_MAP = new HashMap<>();

        public static Double get(Rock rock, RockType type)
        {
        ...
        public Double(Rock rock, RockType type)
        {
            super(rock, type);
    ...
    {
        private static final Map<Rock, EnumMap<RockType, Half>> ROCK_TABLE = new HashMap<>();
        private static final Map<Tree, Half> WOOD_MAP = new HashMap<>();

        public static Half get(Rock rock, RockType type)
        {
            return ROCK_TABLE.get(rock).get(type);
        }
        ...
        public Half(Rock rock, RockType type)
        {
            super(rock, type);
