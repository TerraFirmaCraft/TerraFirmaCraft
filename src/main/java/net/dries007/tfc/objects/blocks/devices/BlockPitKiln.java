...
public class BlockPitKiln extends Block implements ILightableBlock
{
	...
	private static final AxisAlignedBB[] AABB_LEVELS = new AxisAlignedBB[] { PLACED_ITEM_AABB, new AxisAlignedBB(0, 0, 0, 1, 0.0625, 1), new AxisAlignedBB(0, 0, 0, 1, 0.125, 1), new AxisAlignedBB(0, 0, 0, 1, 0.1875, 1), new AxisAlignedBB(0, 0, 0, 1, 0.25, 1), new AxisAlignedBB(0, 0, 0, 1, 0.3125, 1), new AxisAlignedBB(0, 0, 0, 1, 0.375, 1), new AxisAlignedBB(0, 0, 0, 1, 0.4375, 1), new AxisAlignedBB(0, 0, 0, 1, 0.5, 1), new AxisAlignedBB(0, 0, 0, 1, 0.75, 1), FULL_BLOCK_AABB };
	...
	{
		// This is required for the fire code, because forge doesn't 'fix' it to use the
		// location sensitive version.
		return true;
	}
