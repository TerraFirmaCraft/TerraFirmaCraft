...
public class BlockPlantTFC extends BlockBush implements IItemSize
{
	...
	/*
	 * Time of day, used for rendering plants that bloom at different times 0 =
	 * midnight-dawn 1 = dawn-noon 2 = noon-dusk 3 = dusk-midnight
	 */
	...
	public void onEntityCollision(World worldIn, BlockPos pos, IBlockState state, Entity entityIn)
	{
		...
		// todo: make this specific to the plant type (i.e. smaller grasses affect you
	...
	public double getGrowthRate(World world, BlockPos pos)
	{
		if (world.isRainingAt(pos))
			return ConfigTFC.GENERAL.plantGrowthRate * 5d;
		else
			return ConfigTFC.GENERAL.plantGrowthRate;
	}
	...
	protected boolean canSustainBush(IBlockState state)
	{
		if (plant.getIsClayMarking())
			return BlocksTFC.isClay(state) || isValidSoil(state);
		else
