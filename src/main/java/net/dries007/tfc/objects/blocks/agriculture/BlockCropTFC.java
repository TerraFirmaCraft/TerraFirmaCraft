...
{
	/*
	 * true if the crop spawned in the wild, means it ignores growth conditions i.e.
	 * farmland
	 */
	...
	/**
	 * Gets the item stack that the crop will create upon dying and turning into a
	 * placed item
	 */
