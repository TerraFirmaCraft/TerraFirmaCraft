...
public class BlockCropSpreading extends BlockCropTFC
{
	...
	public void grow(World worldIn, Random rand, BlockPos pos, IBlockState state)
	{
		...
		// instead, on growth tick, they will attempt to create a new crop at [age] - 1
		// in adjacent block
	...
	{
		// Seed dropping happens here because it needs to access the TE, which is gone
		// by the time getDrops is called
		TECropSpreading tile = Helpers.getTE(worldIn, pos, TECropSpreading.class);
	...
	public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune)
	{
		...
		// todo: adjust food drops based on player agriculture skill. For now just go
		// with 2 for initial balance
