...
public final class TFCItemGroup extends ItemGroup
{
    ...
    public static final ItemGroup GEM = new TFCItemGroup(TerraFirmaCraft.MOD_ID + ".gems", () -> new ItemStack(TFCItems.GEMS.get(Gem.Default.OPAL).get(Gem.Grade.CUT).get()));
    ...
    public static final ItemGroup MISC = new TFCItemGroup(TerraFirmaCraft.MOD_ID + ".misc", () -> new ItemStack(TFCItems.ROCK_ITEMS.get(Rock.Default.CHERT).get(RockCategory.RockItems.BRICK).get()));
