...
public class TECharcoalForge extends TEInventory implements ITickable, ITileFields
{
	...
	public TECharcoalForge()
	{
		...
		// 5 - 9 are the input slots. Same arrangement (0 lowest, then alternating L, R,
		// L high, R high)
		// 10 - 13 are the extra slots for molds and stuff. 10 at the top, 14 at the
		// bottom. Iterate in that order
		super(14);
