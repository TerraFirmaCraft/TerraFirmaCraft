...
/**
 * This is a helper class for TE's with a simple inventory that will respect
 * automation To provide side based automation, you must expose a IItemHandler
 * wrapper based on the input side Without overriding the getCapability methods,
 * this will not accept items from external automation
 */
...
public abstract class TEInventory extends TEBase implements ISlotCallback
{
	...
	/**
	 * Delegated from
	 * {@link net.minecraft.inventory.Container#canInteractWith(EntityPlayer)}
	 */
