...
public class FamiliarizationTrigger implements ICriterionTrigger<FamiliarizationTrigger.Instance>
{
    ...
    private final Map<PlayerAdvancements, FamiliarizationTrigger.Listeners> listeners = Maps.newHashMap();

    public FamiliarizationTrigger()
    {
    }
    ...
    static class Listeners
    {
        ...
        public void add(Listener<FamiliarizationTrigger.Instance> listener)
        {
            this.listeners.add(listener);
        }

        public void remove(Listener<FamiliarizationTrigger.Instance> listener)
        {
            this.listeners.remove(listener);
        }

        public <T extends EntityAnimal & IAnimalTFC> void trigger(T animal)
        {
