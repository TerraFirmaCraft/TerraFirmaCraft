    ...
    public boolean matches(InventoryCrafting inv, World worldIn)
    {
        ...
        for (int i = 0; i < inv.getSizeInventory(); i++)
        {
            ...
            if (!stack.isEmpty())
            {
                ...
                if (!stack.hasCapability(CapabilityNutrients.CAPABILITY_NUTRIENTS, null))
                {
                    return false;
                }
    ...
    public ItemStack getCraftingResult(InventoryCrafting inv)
    {
        ...
        for (int i = 0; i < inv.getSizeInventory(); i++)
        {
            ...
            if (!stack.isEmpty())
            {
                ...
                IFood cap = stack.getCapability(CapabilityNutrients.CAPABILITY_NUTRIENTS, null);
                if (cap != null)
                {
        ...
        IFood cap = resultStack.getCapability(CapabilityNutrients.CAPABILITY_NUTRIENTS, null);
        if (cap != null)
        {
