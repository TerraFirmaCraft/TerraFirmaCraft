...
public class ItemBlockPlant extends ItemBlockTFC
{
	...
	{
		// todo: useful for testing, not sure if this feature will stay for release, tie
		// to agriculture skill if we keep it
		return true;
	}
	...
	{
		// todo: tie plant tooltips into agriculture skill, probably add more detail at
		// higher levels and less at lower levels
