...
public class ItemGoldPan extends ItemTFC
{
	...
	{
		// todo: move to public EnumActionResult onItemUse(EntityPlayer player, World
		// worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float
		// hitY, float hitZ)
		...
		if (handIn != EnumHand.MAIN_HAND)
			return new ActionResult<>(EnumActionResult.PASS, stack);
		if (canPan(worldIn, playerIn) == null)
