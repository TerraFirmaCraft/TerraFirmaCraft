...
public final class ItemsTFC
{
	...
	public static void registerItems(RegistryEvent.Register<Item> event)
	{
		...
		{ // POTTERY
			for (Metal.ItemType type : Metal.ItemType.values())
			{
				...
				{
					// Not using registerPottery here because the ItemMold uses a custom
					// ItemModelMesher, meaning it can't be in simpleItems
		...
		// Note: if you add items you don't need to put them in this list of todos. Feel
		// free to add them where they make sense :)
		// todo: Bow? Arrows?
		// todo: Fishing rod?
		...
		// todo: shears? Higher durability versions for different metals
		// (iron/streels/others?)?
		// todo: flint & steel? Higher durability versions for different metals
		// (iron/steels)?
		...
		// todo: foods & plants & seeds & fruits & fruit tree saplings & berries & berry
		// bushes
	...
	private static void registerPottery(Builder<Item> items, IForgeRegistry<Item> r, String nameUnfired, String nameFired, ItemUnfiredPottery unfiredPottery)
	{
		...
		if (items != null)
			items.add(unfiredPottery.firedVersion, unfiredPottery);
	}
