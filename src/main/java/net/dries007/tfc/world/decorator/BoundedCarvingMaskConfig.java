...
public class BoundedCarvingMaskConfig implements DecoratorConfiguration
{
    ...
    public BoundedCarvingMaskConfig(int minY, int maxY, float probability, GenerationStep.Carving step)
    {
        this.minY = minY;
        this.maxY = maxY;
