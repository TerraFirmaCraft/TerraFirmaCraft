...
public class TFCFeatures
{
    ...
    public static final RegistryObject<SubmergedTallPlantFeature> TALL_AQUATIC_PLANT = register("submerged_tall_plant", SubmergedTallPlantFeature::new, SubmergedTallPlantFeature.CODEC);
