...
public class ChunkGenTFC implements IChunkGenerator
{
    ...
    public ChunkGenTFC(World w, String settingsString)
    {
        ...
        rocksGenLayer1 = GenLayerTFC.initializeRock(seed + 1, RockCategory.Layer.TOP, s.enableSmallRockLayerSize);
        rocksGenLayer2 = GenLayerTFC.initializeRock(seed + 2, RockCategory.Layer.MIDDLE, s.enableSmallRockLayerSize);
        rocksGenLayer3 = GenLayerTFC.initializeRock(seed + 3, RockCategory.Layer.BOTTOM, s.enableSmallRockLayerSize);
