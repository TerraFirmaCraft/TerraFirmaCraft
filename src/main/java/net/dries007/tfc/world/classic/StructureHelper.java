...
{
	/**
	 * This is a copy of the method included in the Template class, with some key
	 * differences. This will ignore TEs / Entities, and does less checks for bad
	 * usage, since it will only be used for tree worldgen It will do an additional
	 * check that the block is replaceable; important for tree growth; as to not
