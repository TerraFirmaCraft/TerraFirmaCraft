...
public class TreeGenVariants implements ITreeGenerator
{
	...
	/**
	 * A tree generator which select a random structure to place. Can choose to use
	 * a random rotation as well
	 *
	 * @param useRotation Should it try and randomly rotate the structures on
	 *                    placement
	 * @param variants    The list of variants for the generator to look for.
	 *                    Structure files should be placed in assets/tfc/[TREE
	 *                    NAME]/ This needs to be the list of file names, (i.e.
	 *                    "tree1.nbt" should pass in "tree1")
	 */
	 ...
	 * @param useRotation Should it try and randomly rotate the structures on
	 *                    placement
	 * @param numVariants The number of variant files. Files need to be named 1.nbt,
	 *                    2.nbt, 3.nbt ...
	 */
