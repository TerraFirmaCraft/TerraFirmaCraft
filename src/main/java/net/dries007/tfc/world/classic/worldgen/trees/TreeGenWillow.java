...
/**
 * This is a tree generator only used for the willow tree shapes. Requires two
 * structure blocks: both found in /assets/tfc/[TREE NAME]/, named base.nbt and
 * overlay.nbt respectively. See the examples for TFC willow tree for what the
...
public class TreeGenWillow implements ITreeGenerator
{
	...
	public void generateTree(TemplateManager manager, World world, BlockPos pos, Tree tree, Random rand)
	{
		...
		int height = 5 + rand.nextInt(3), branches = 2 + rand.nextInt(3), x1, z1, y1;
