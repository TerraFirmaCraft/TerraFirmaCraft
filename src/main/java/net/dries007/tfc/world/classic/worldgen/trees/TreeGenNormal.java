...
public class TreeGenNormal implements ITreeGenerator
{
	...
	/**
	 * A basic tree generator. It will generate a structure found in
	 * /assets/tfc/[TREE NAME]/base.nbt Additionally, it will try and apply an
	 * overlay with the name /overlay.nbt at 50% integrity.
	 *
	 * @param heightMin   The minimum amount of logs to add to the bottom of the
	 *                    trunk Set to 0 for no extra height
	 * @param heightRange The maximum amount of logs to add to the bottom of the
	 *                    trunk. Set to 0 for no extra height
	 */
