...
public class VeinCluster extends Vein
{
	...
	public VeinCluster(BlockPos pos, VeinType veinType, Ore.Grade grade, Random rand)
	{
		...
		{
			final BlockPos clusterPos = pos.add(1.5 * horizontalModifier * (0.5 - rand.nextDouble()), 1.5 * verticalModifier * (0.5 - rand.nextDouble()), 1.5 * horizontalModifier * (0.5 - rand.nextDouble()));
