...
public class WorldGenTrees implements IWorldGenerator
{
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider)
	{
		...
		// It will create sparse trees ( < 1 per chunk) by averaging the climate data to
		// make it more temperate
		// The thought is in very harsh conditions, a few trees might survive outside
		// their typical temperature zone
		if (trees.isEmpty())
		{
