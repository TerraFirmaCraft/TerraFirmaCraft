...
public enum ChooseBiomes implements RegionTask
{
    ...
    private static final int[] HIGH_ALTITUDE_BIOMES = {HIGHLANDS, HIGHLANDS, ROLLING_HILLS, INVERTED_BADLANDS, BADLANDS, PLATEAU, PLATEAU, OLD_MOUNTAINS, OLD_MOUNTAINS};
