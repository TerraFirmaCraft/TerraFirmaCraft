...
public enum ChooseBiomes implements RegionTask
{
    ...
    private static final int[] MOUNTAIN_ALTITUDE_BIOMES = {MOUNTAINS, MOUNTAINS, MOUNTAINS, OLD_MOUNTAINS, OLD_MOUNTAINS, PLATEAU};
    ...
    private static final int[] HIGH_ALTITUDE_BIOMES = {HILLS, ROLLING_HILLS, ROLLING_HILLS, INVERTED_BADLANDS, BADLANDS, PLATEAU, PLATEAU, OLD_MOUNTAINS, OLD_MOUNTAINS};
    private static final int[] MID_ALTITUDE_BIOMES = {PLAINS, HILLS, ROLLING_HILLS, INVERTED_BADLANDS, BADLANDS, PLATEAU, CANYONS, LOW_CANYONS, LOWLANDS};
    private static final int[] LOW_ALTITUDE_BIOMES = {PLAINS, PLAINS, HILLS, HILLS, ROLLING_HILLS, LOW_CANYONS, LOWLANDS};
