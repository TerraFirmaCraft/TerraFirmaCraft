...
public final class TFCBiomes
{
    ...
    public static final BiomeExtension ATOLL = register("atoll", builder().heightmap(seed -> BiomeNoise.canyons(seed, -6, 5)).atoll().surface(AtollSurfaceBuilder.INSTANCE).aquiferHeightOffset(-24).type(BiomeBlendType.LAND).salty().noRivers()); // Sharp, small hills, with lots of water / snaking winding rivers.
