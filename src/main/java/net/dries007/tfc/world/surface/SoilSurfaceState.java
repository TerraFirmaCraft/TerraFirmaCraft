...
public class SoilSurfaceState implements SurfaceState
{
    ...
    public static SurfaceState buildSurfaceType(SoilBlockType type, SurfaceState dry)
    {
        final ImmutableList<SurfaceState> regions = ImmutableList.of(
            ...
            soil(type, SoilBlockType.Variant.ARIDISOL),
            blobTransition(soil(type, SoilBlockType.Variant.ARIDISOL), soil(type, SoilBlockType.Variant.ENTISOL)),
            soil(type, SoilBlockType.Variant.ENTISOL), // TODO: This should actually be a temp-based transition between entisol and oxisol
            soil(type, SoilBlockType.Variant.ENTISOL),
            soil(type, SoilBlockType.Variant.ENTISOL),
            soil(type, SoilBlockType.Variant.ENTISOL),
            soil(type, SoilBlockType.Variant.ENTISOL),
            soil(type, SoilBlockType.Variant.ENTISOL),
