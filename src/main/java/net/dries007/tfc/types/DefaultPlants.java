...
public final class DefaultPlants
{
    ...
    public static void onPreRegisterPlant(TFCRegistryEvent.RegisterPreBlock<Plant> event)
    {
        event.getRegistry().registerAll(
            // Standard Plants
            new Plant(ALLIUM, Plant.PlantType.STANDARD, false, 8f, -40f, 33f, 150f, 500f, 12, 15, 1, null),
            ...
            new Plant(TULIP_ORANGE, Plant.PlantType.STANDARD, false, 15f, -34f, 33f, 100f, 200f, 9, 15, 1, null),
            new Plant(TULIP_PINK, Plant.PlantType.STANDARD, false, 15f, -34f, 33f, 100f, 200f, 9, 15, 1, null),
            new Plant(TULIP_RED, Plant.PlantType.STANDARD, false, 15f, -34f, 33f, 100f, 200f, 9, 15, 1, null),
            new Plant(TULIP_WHITE, Plant.PlantType.STANDARD, false, 15f, -34f, 33f, 100f, 200f, 9, 15, 1, null),

            // Desert Plants
            new Plant(PEROVSKIA, Plant.PlantType.DESERT, true, 20f, -29f, 32f, 0f, 200f, 9, 15, 1, null),
            new Plant(SAGEBRUSH, Plant.PlantType.DESERT, false, 20f, -34f, 50f, 0f, 100f, 12, 15, 1, null),

            // Cactus Plants
            new Plant(BARREL_CACTUS, Plant.PlantType.CACTUS, false, 18f, -6f, 50f, 0f, 75f, 12, 15, 3, "blockCactus"),
            ...
            new Plant(LILYPAD, Plant.PlantType.FLOATING, false, 18f, -34f, 38f, 0f, 500f, 4, 15, 1, 1, 1, null),

            // Grass
            new Plant(RYEGRASS, Plant.PlantType.SHORT_GRASS, false, 10f, -46f, 32f, 150f, 300f, 12, 15, 1, null),
            new Plant(SWITCHGRASS, Plant.PlantType.TALL_GRASS, false, 15f, -29f, 32f, 100f, 300f, 9, 15, 2, null),

            // Placeholder plants
            // todo: replace textures, models, and/or add seasonal varieties
            new Plant(ATHYRIUM_FERN, Plant.PlantType.STANDARD, true, 15f, -34f, 32f, 200f, 500f, 9, 15, 1, null),
            new Plant(CANNA, Plant.PlantType.STANDARD, true, 18f, -12f, 36f, 150f, 500f, 9, 15, 1, null),
            new Plant(CATTAIL, Plant.PlantType.EMERGENT_TALL_WATER, false, 15f, -36f, 40f, 0f, 500f, 4, 15, 2, 1, 1, null),
            new Plant(DUCKWEED, Plant.PlantType.FLOATING, false, 11f, -34f, 38f, 0f, 500f, 4, 15, 1, 1, 32, null),
            new Plant(FOUNTAIN_GRASS, Plant.PlantType.SHORT_GRASS, false, 18f, -12f, 40f, 75f, 150f, 12, 15, 1, null),
            new Plant(FOXGLOVE, Plant.PlantType.STANDARD, false, 15f, -34f, 34f, 150f, 300f, 9, 15, 1, null),
            new Plant(GUTWEED, Plant.PlantType.WATER_SEA, false, 17f, -21f, 40f, 0f, 500f, 4, 15, 1, 1, 7, "seaweed"),
            new Plant(GUZMANIA, Plant.PlantType.EPIPHYTE, false, 20f, 10f, 50f, 200f, 500f, 4, 11, 1, null),
            new Plant(LICORICE_FERN, Plant.PlantType.EPIPHYTE, false, 5f, -29f, 25f, 300f, 500f, 4, 11, 1, null),
            new Plant(LOTUS, Plant.PlantType.FLOATING, false, 20f, 10f, 50f, 0f, 500f, 4, 15, 1, 1, 1, null),
            new Plant(HORSETAIL, Plant.PlantType.REED, false, 5f, -40f, 33f, 300f, 500f, 9, 15, 1, null),
            new Plant(ORCHARD_GRASS, Plant.PlantType.SHORT_GRASS, false, 15f, -29f, 30f, 75f, 300f, 9, 15, 1, null),
            new Plant(PAMPAS_GRASS, Plant.PlantType.TALL_GRASS, true, 20f, -12f, 36f, 75f, 200f, 9, 15, 2, null),
            new Plant(PISTIA, Plant.PlantType.FLOATING, false, 20f, 10f, 50f, 0f, 500f, 4, 15, 1, 2, 32, null),
            new Plant(PRIMROSE, Plant.PlantType.STANDARD, false, 15f, -34f, 33f, 150f, 300f, 9, 11, 1, null),
            new Plant(ROSE, Plant.PlantType.TALL_PLANT, true, 11f, -29f, 34f, 150f, 300f, 9, 15, 2, null),
            new Plant(SACRED_DATURA, Plant.PlantType.STANDARD, false, 20f, 5f, 33f, 300f, 500f, 12, 15, 1, null),
            new Plant(SAGO, Plant.PlantType.WATER, false, 11f, -34f, 38f, 0f, 500f, 4, 15, 1, 1, 3, null),
            new Plant(SARGASSUM, Plant.PlantType.FLOATING_SEA, false, 18f, 0f, 38f, 0f, 500f, 12, 15, 1, 5, 256, "seaweed"),
            new Plant(SCUTCH_GRASS, Plant.PlantType.SHORT_GRASS, false, 18f, -17f, 40f, 150f, 500f, 12, 15, 1, null),
            new Plant(SUGAR_CANE, Plant.PlantType.TALL_REED, false, 18f, 10f, 40f, 300f, 500f, 12, 15, 3, "sugarcane"),
            new Plant(SWORD_FERN, Plant.PlantType.STANDARD, false, 18f, -40f, 30f, 100f, 200f, 4, 11, 1, null),
            new Plant(TALL_FESCUE_GRASS, Plant.PlantType.TALL_GRASS, false, 15f, -29f, 30f, 300f, 500f, 12, 15, 2, null),
