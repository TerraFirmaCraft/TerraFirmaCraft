...
public final class DefaultTrees
{
    ...
    public static void onPreRegisterRockCategory(TFCRegistryEvent.RegisterPreBlock<Tree> event)
    {
        event.getRegistry().registerAll(
            ...
            new Tree.Builder(ASH, 60f, 140f, -6f, 12f, GEN_NORMAL).setRadius(0).setBurnInfo(696f, 1250).build(),
            ...
            new Tree.Builder(HICKORY, 80f, 250f, 7f, 29f, GEN_TALL).setRadius(0).setGrowthTime(10).setTannin().setBurnInfo(762f, 2000).build(),
            ...
            new Tree.Builder(WHITE_CEDAR, 10f, 240f, -8f, 17f, GEN_TALL).setRadius(0).setHeight(16).setBurnInfo(625f, 1500).build(),
