...
public final class DefaultMetals
{
	...
	{
		event.getRegistry().registerAll(new Ore(NATIVE_COPPER, COPPER), new Ore(NATIVE_GOLD, GOLD), new Ore(NATIVE_PLATINUM, PLATINUM), new Ore(HEMATITE, PIG_IRON), new Ore(NATIVE_SILVER, SILVER), new Ore(CASSITERITE, TIN), new Ore(GALENA, LEAD), new Ore(BISMUTHINITE, BISMUTH), new Ore(GARNIERITE, NICKEL), new Ore(MALACHITE, COPPER), new Ore(MAGNETITE, PIG_IRON), new Ore(LIMONITE, PIG_IRON), new Ore(SPHALERITE, ZINC), new Ore(TETRAHEDRITE, COPPER), new Ore(BITUMINOUS_COAL), new Ore(LIGNITE), new Ore(KAOLINITE), new Ore(GYPSUM), new Ore(SATINSPAR), new Ore(SELENITE), new Ore(GRAPHITE), new Ore(KIMBERLITE), new Ore(PETRIFIED_WOOD), new Ore(SULFUR), new Ore(JET), new Ore(MICROCLINE), new Ore(PITCHBLENDE), new Ore(CINNABAR), new Ore(CRYOLITE), new Ore(SALTPETER), new Ore(SERPENTINE), new Ore(SYLVITE), new Ore(BORAX), new Ore(OLIVINE), new Ore(LAPIS_LAZULI));
	}

	@SubscribeEvent
	public static void onPreRegisterMetal(TFCRegistryEvent.RegisterPreBlock<Metal> event)
	{
		event.getRegistry().registerAll(new Metal(BISMUTH, TIER_I, true, 0.14f, 270, 0xFF486B72, null), new Metal(BISMUTH_BRONZE, TIER_II, true, 0.35f, 985, 0xFF418E4F, ToolMaterialsTFC.BISMUTH_BRONZE), new Metal(BLACK_BRONZE, TIER_II, true, 0.35f, 1070, 0xFF3B2636, ToolMaterialsTFC.BLACK_BRONZE), new Metal(BRASS, TIER_I, true, 0.35f, 930, 0xFF96892E, null), new Metal(BRONZE, TIER_II, true, 0.35f, 950, 0xFF7C5E33, ToolMaterialsTFC.BRONZE), new Metal(COPPER, TIER_I, true, 0.35f, 1080, 0xFFB64027, ToolMaterialsTFC.COPPER), new Metal(GOLD, TIER_I, true, 0.6f, 1060, 0xFFDCBF1B, null), new Metal(LEAD, TIER_I, true, 0.22f, 328, 0xFF40494D, null), new Metal(NICKEL, TIER_I, true, 0.48f, 1453, 0xFF4E4E3C, null), new Metal(ROSE_GOLD, TIER_I, true, 0.35f, 960, 0xFFEB7137, null), new Metal(SILVER, TIER_I, true, 0.48f, 961, 0xFF949495, null), new Metal(TIN, TIER_I, true, 0.14f, 230, 0xFF90A4BB, null), new Metal(ZINC, TIER_I, true, 0.21f, 420, 0xFFBBB9C4, null),
				new Metal(STERLING_SILVER, TIER_I, true, 0.35f, 900, 0xFFAC927B, null), new Metal(WROUGHT_IRON, TIER_III, true, 0.35f, 1535, 0xFF989897, ToolMaterialsTFC.IRON), new Metal(PIG_IRON, TIER_III, true, 0.35f, 1535, 0xFF6A595C, null), new Metal(STEEL, TIER_IV, true, 0.35f, 1540, 0xFF5F5F5F, ToolMaterialsTFC.STEEL), new Metal(PLATINUM, TIER_V, true, 0.35f, 1730, 0xFF9DADC0, null), new Metal(BLACK_STEEL, TIER_V, true, 0.35f, 1485, 0xFF111111, ToolMaterialsTFC.BLACK_STEEL), new Metal(BLUE_STEEL, TIER_VI, true, 0.35f, 1540, 0xFF2D5596, ToolMaterialsTFC.BLUE_STEEL), new Metal(RED_STEEL, TIER_VI, true, 0.35f, 1540, 0xFF700503, ToolMaterialsTFC.RED_STEEL), new Metal(WEAK_STEEL, TIER_V, false, 0.35f, 1540, 0xFF111111, null), new Metal(WEAK_BLUE_STEEL, TIER_V, false, 0.35f, 1540, 0xFF2D5596, null), new Metal(WEAK_RED_STEEL, TIER_V, false, 0.35f, 1540, 0xFF700503, null), new Metal(HIGH_CARBON_STEEL, TIER_IV, false, 0.35f, 1540, 0xFF5F5F5F, null),
				new Metal(HIGH_CARBON_BLUE_STEEL, TIER_V, false, 0.35f, 1540, 0xFF2D5596, null), new Metal(HIGH_CARBON_RED_STEEL, TIER_V, false, 0.35f, 1540, 0xFF700503, null), new Metal(HIGH_CARBON_BLACK_STEEL, TIER_V, false, 0.35f, 1540, 0xFF111111, null), new Metal(UNKNOWN, TIER_I, false, 0.5f, 1250, 0xFF2F2B27, null));
	}

	@SubscribeEvent
	public static void onRegisterAlloyRecipe(RegistryEvent.Register<AlloyRecipe> event)
	{
		event.getRegistry().registerAll(new AlloyRecipe.Builder(BISMUTH_BRONZE).add(ZINC, 0.2, 0.3).add(COPPER, 0.5, 0.65).add(BISMUTH, 0.1, 0.2).build(), new AlloyRecipe.Builder(BLACK_BRONZE).add(COPPER, 0.5, 0.7).add(SILVER, 0.1, 0.25).add(GOLD, 0.1, 0.25).build(), new AlloyRecipe.Builder(BRONZE).add(COPPER, 0.88, 0.92).add(TIN, 0.08, 0.12).build(), new AlloyRecipe.Builder(BRASS).add(COPPER, 0.88, 0.92).add(ZINC, 0.08, 0.12).build(), new AlloyRecipe.Builder(ROSE_GOLD).add(COPPER, 0.15, 0.3).add(GOLD, 0.7, 0.85).build(), new AlloyRecipe.Builder(STERLING_SILVER).add(COPPER, 0.2, 0.4).add(SILVER, 0.6, 0.8).build(), new AlloyRecipe.Builder(WEAK_STEEL).add(STEEL, 0.5, 0.7).add(NICKEL, 0.15, 0.25).add(BLACK_BRONZE, 0.15, 0.25).build(), new AlloyRecipe.Builder(WEAK_BLUE_STEEL).add(BLACK_STEEL, 0.5, 0.55).add(STEEL, 0.2, 0.25).add(BISMUTH_BRONZE, 0.1, 0.15).add(STERLING_SILVER, 0.1, 0.15).build(),
