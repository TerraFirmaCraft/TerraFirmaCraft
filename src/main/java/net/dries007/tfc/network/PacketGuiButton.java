...
/**
 * This is a generic packet that sends a button notification to the players open
 * container, which can delegate to the tile entity if needed See
 * {@link net.dries007.tfc.client.gui.GuiAnvilTFC} for an example of its usage,
 * and {@link net.dries007.tfc.objects.container.ContainerAnvilTFC} for an
 * example of the message handling
 *
