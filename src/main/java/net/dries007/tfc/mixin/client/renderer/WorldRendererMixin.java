...
public abstract class WorldRendererMixin
{
    ...
    {
        return Climate.getTemperature(level, pos, biome);
    }
    ...
    private Biome.RainType redirect$renderSnowAndRain$getPrecipitation(Biome biome, LightTexture lightmapIn, float partialTicks, double xIn, double yIn, double zIn)
    {
        ...
        return Climate.getPrecipitation(level, mutablePos, biome);
    }
    ...
    {
        return Climate.getPrecipitation(level, activeRenderInfo.getBlockPosition(), biome);
    }
}
