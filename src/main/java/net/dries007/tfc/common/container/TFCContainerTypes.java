...
public final class TFCContainerTypes
{
    ...
    public static final RegistryObject<ContainerType<KnappingContainer>> CLAY_KNAPPING = register("clay_knapping", ((((windowId, inv, data) -> new KnappingContainer(TFCContainerTypes.CLAY_KNAPPING.get(), TFCRecipeTypes.CLAY_KNAPPING, windowId, inv, 5, true, true, false, TFCSounds.KNAP_CLAY.get())))));
    public static final RegistryObject<ContainerType<KnappingContainer>> FIRE_CLAY_KNAPPING = register("fire_clay_knapping", ((((windowId, inv, data) -> new KnappingContainer(TFCContainerTypes.FIRE_CLAY_KNAPPING.get(), TFCRecipeTypes.FIRE_CLAY_KNAPPING, windowId, inv, 5, true, true, false, TFCSounds.KNAP_CLAY.get())))));
    public static final RegistryObject<ContainerType<KnappingContainer>> LEATHER_KNAPPING = register("leather_knapping", ((((windowId, inv, data) -> new KnappingContainer(TFCContainerTypes.LEATHER_KNAPPING.get(), TFCRecipeTypes.LEATHER_KNAPPING, windowId, inv, 1, false, false, true, TFCSounds.KNAP_LEATHER.get())))));
    public static final RegistryObject<ContainerType<KnappingContainer>> ROCK_KNAPPING = register("rock_knapping", ((((windowId, inv, data) -> new KnappingContainer(TFCContainerTypes.ROCK_KNAPPING.get(), TFCRecipeTypes.ROCK_KNAPPING, windowId, inv, 1, false, false, false, TFCSounds.KNAP_STONE.get())))));
