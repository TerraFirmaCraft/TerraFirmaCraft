...
public final class TFCContainerTypes
{
    ...
    public static final RegistryObject<ContainerType<TFCWorkbenchContainer>> WORKBENCH = register("workbench", (((windowId, inv, data) -> new TFCWorkbenchContainer(TFCContainerTypes.WORKBENCH.get(), windowId, inv))));
