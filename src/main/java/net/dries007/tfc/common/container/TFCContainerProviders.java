...
public class TFCContainerProviders
{
    ...
    public static final INamedContainerProvider LEATHER_KNAPPING = new SimpleNamedContainerProvider((windowId, inv, player) -> new KnappingContainer(TFCContainerTypes.LEATHER_KNAPPING.get(), windowId, player.inventory, 1, false, false, TFCRecipeTypes.LEATHER_KNAPPING), new TranslationTextComponent("tfc.screen.leather_knapping"));
    public static final INamedContainerProvider ROCK_KNAPPING = new SimpleNamedContainerProvider((windowId, inv, player) -> new KnappingContainer(TFCContainerTypes.ROCK_KNAPPING.get(), windowId, player.inventory, 1, false, false, TFCRecipeTypes.ROCK_KNAPPING), new TranslationTextComponent("tfc.screen.rock_knapping"));
}