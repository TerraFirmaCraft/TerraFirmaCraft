...
public class TFCContainerProviders
{
    ...
    public static final INamedContainerProvider CLAY_KNAPPING = new SimpleNamedContainerProvider((windowId, inv, player) -> new KnappingContainer(TFCContainerTypes.CLAY_KNAPPING.get(), TFCRecipeTypes.CLAY_KNAPPING, windowId, player.inventory, 5, true, true, false, TFCSounds.KNAP_CLAY.get()), new TranslationTextComponent("tfc.screen.clay_knapping"));
    public static final INamedContainerProvider FIRE_CLAY_KNAPPING = new SimpleNamedContainerProvider((windowId, inv, player) -> new KnappingContainer(TFCContainerTypes.FIRE_CLAY_KNAPPING.get(), TFCRecipeTypes.FIRE_CLAY_KNAPPING, windowId, player.inventory,5, true, true, false, TFCSounds.KNAP_CLAY.get()), new TranslationTextComponent("tfc.screen.fire_clay_knapping"));
    public static final INamedContainerProvider LEATHER_KNAPPING = new SimpleNamedContainerProvider((windowId, inv, player) -> new KnappingContainer(TFCContainerTypes.LEATHER_KNAPPING.get(), TFCRecipeTypes.LEATHER_KNAPPING, windowId, player.inventory, 1, false, false, true, TFCSounds.KNAP_LEATHER.get()), new TranslationTextComponent("tfc.screen.leather_knapping"));
    public static final INamedContainerProvider ROCK_KNAPPING = new SimpleNamedContainerProvider((windowId, inv, player) -> new KnappingContainer(TFCContainerTypes.ROCK_KNAPPING.get(), TFCRecipeTypes.ROCK_KNAPPING, windowId, player.inventory, 1, false, false, false, TFCSounds.KNAP_STONE.get()), new TranslationTextComponent("tfc.screen.rock_knapping"));
}