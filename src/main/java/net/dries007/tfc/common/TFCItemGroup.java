...
{
    public static final ItemGroup EARTH_BLOCKS = new TFCItemGroup(TerraFirmaCraft.MOD_ID + ".rock.blocks", () -> new ItemStack(TFCBlocks.ROCKS.get(Rock.Default.QUARTZITE).get(Rock.BlockType.RAW).get()));
