...
public class TFCAvoidEntityGoal<T extends LivingEntity> extends AvoidEntityGoal<T>
{
    ...
    {
        // we copy over this method completely to avoid doubling the extremely expensive getNearestEntity call
        ...
        {
            if (toAvoid.isSteppingCarefully() && !toAvoid.isInWater()) return false; //tfc: you can sneak up on fish when on land
