...
public class TFCEntities
{
    ...
    public static void onEntityAttributeCreation(EntityAttributeCreationEvent event)
    {
        ...
        event.put(PIG.get(), Pig.createAttributes().add(ForgeMod.STEP_HEIGHT_ADDITION.get(), 0.5F).build());
        event.put(COW.get(), Cow.createAttributes().add(ForgeMod.STEP_HEIGHT_ADDITION.get(), 0.5F).build());
        event.put(GOAT.get(), Pig.createAttributes().add(ForgeMod.STEP_HEIGHT_ADDITION.get(), 0.5F).build());
        event.put(YAK.get(), Cow.createAttributes().add(ForgeMod.STEP_HEIGHT_ADDITION.get(), 0.5F).build());
        event.put(ALPACA.get(), Cow.createAttributes().add(ForgeMod.STEP_HEIGHT_ADDITION.get(), 0.5F).build());
        event.put(SHEEP.get(), Cow.createAttributes().add(ForgeMod.STEP_HEIGHT_ADDITION.get(), 0.5F).build());
        event.put(MUSK_OX.get(), Cow.createAttributes().add(ForgeMod.STEP_HEIGHT_ADDITION.get(), 0.5F).build());
