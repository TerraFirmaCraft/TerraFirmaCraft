...
public class TFCEntities
{
    ...
    public static final RegistryObject<EntityType<JellyfishEntity>> JELLYFISH = register("jellyfish", EntityType.Builder.of(JellyfishEntity::new, EntityClassification.WATER_AMBIENT).sized(0.3F, 0.5F).clientTrackingRange(4));
