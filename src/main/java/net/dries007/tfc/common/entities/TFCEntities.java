...
public class TFCEntities
{
    ...
    public static final RegistryObject<EntityType<Prey>> MOOSE = register("moose", EntityType.Builder.of(TFCEntities::makeMoose, MobCategory.CREATURE).sized(1.2F, 3.0F).clientTrackingRange(10));
