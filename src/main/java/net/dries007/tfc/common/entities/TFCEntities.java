...
public class TFCEntities
{
    ...
    public static final RegistryObject<EntityType<Prey>> MOOSE = register("moose", EntityType.Builder.of(TFCEntities::makeMoose, MobCategory.CREATURE).sized(2.6F, 3.4F).clientTrackingRange(10));
