...
public final class TFCItems
{
    ...
    public static final Map<DyeColor, RegistryObject<Item>> COLORED_WINDMILL_BLADES = Helpers.mapOfKeys(DyeColor.class, color -> color != DyeColor.WHITE, color ->
        register(color.getSerializedName() + "_windmill_blade", () -> new WindmillBladeItem(new Item.Properties()))
    );
    public static final RegistryObject<Item> LATTICE_WINDMILL_BLADE = register("lattice_windmill_blade", () -> new WindmillBladeItem(new Item.Properties()));
    public static final RegistryObject<Item> RUSTIC_WINDMILL_BLADE = register("rustic_windmill_blade", () -> new WindmillBladeItem(new Item.Properties()));
