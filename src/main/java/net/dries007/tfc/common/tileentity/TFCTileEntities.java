...
public class TFCTileEntities
{
    ...
    public static final RegistryObject<TileEntityType<TickCounterTileEntity>> TICK_COUNTER = register("tick_counter", TickCounterTileEntity::new, Stream.of(SAPLING_LIST, TFCBlocks.FRUIT_TREE_SAPLINGS.values(), Arrays.asList(TFCBlocks.TORCH, TFCBlocks.WALL_TORCH, TFCBlocks.DEAD_BERRY_BUSH, TFCBlocks.DEAD_CANE)).flatMap(Collection::stream));
    ...
    public static final RegistryObject<TileEntityType<BranchTileEntity>> BRANCH = register("branch", BranchTileEntity::new, TFCBlocks.FRUIT_TREE_GROWING_BRANCHES.values().stream());
