...
public final class TFCTiers
{
    ...
    public static final Tier WROUGHT_IRON = register("wrought_iron", List.of(BRONZE, BISMUTH_BRONZE, BLACK_BRONZE), List.of(Tiers.DIAMOND), TFCTags.Blocks.NEEDS_WROUGHT_IRON_TOOL, 3, 2200, 8.0f, 4.75f, 12);
