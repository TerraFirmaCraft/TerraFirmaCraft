...
public class TFCRecipeSerializers
{
    ...
    public static final RegistryObject<KnappingRecipe.Serializer> CLAY_KNAPPING = register("clay_knapping", () -> new KnappingRecipe.Serializer(TFCRecipeTypes.CLAY_KNAPPING.get()));
    public static final RegistryObject<KnappingRecipe.Serializer> FIRE_CLAY_KNAPPING = register("fire_clay_knapping", () -> new KnappingRecipe.Serializer(TFCRecipeTypes.FIRE_CLAY_KNAPPING.get()));
    public static final RegistryObject<KnappingRecipe.Serializer> LEATHER_KNAPPING = register("leather_knapping", () -> new KnappingRecipe.Serializer(TFCRecipeTypes.LEATHER_KNAPPING.get()));
    ...
    public static final RegistryObject<SealedBarrelRecipe.Serializer> SEALED_BARREL = register("sealed_barrel", SealedBarrelRecipe.Serializer::new);
    public static final RegistryObject<InstantBarrelRecipe.Serializer> INSTANT_BARREL = register("instant_barrel", InstantBarrelRecipe.Serializer::new);
