...
public class AdvancedPotRecipe extends PotRecipe
{
    protected final FluidStack outputFluid;
    protected final List<ItemStackProvider> outputProviders;

    public AdvancedPotRecipe(ResourceLocation id, List<Ingredient> itemIngredients, FluidStackIngredient fluidIngredient, int duration, float minTemp, FluidStack outputFluid, List<ItemStackProvider> outputProviders)
    {
    ...
    {
        return TFCRecipeSerializers.POT_ADVANCED.get();
    }
    ...
    record AdvancedOutput(FluidStack stack, List<ItemStackProvider> providers) implements Output
    {
        ...
        public void onFinish(PotBlockEntity.PotInventory inventory)
        {
            ...
            {
                final ItemStack prev = inventory.getStackInSlot(i);
                inventory.setStackInSlot(i + PotBlockEntity.SLOT_EXTRA_INPUT_START, providers.get(i).getSingleStack(prev));
            }
    ...
    public static class Serializer extends PotRecipe.Serializer<AdvancedPotRecipe>
    {
        @Override
        public void toNetwork(FriendlyByteBuf buffer, AdvancedPotRecipe recipe)
        {
        ...
        @Override
        protected AdvancedPotRecipe fromJson(ResourceLocation recipeId, JsonObject json, List<Ingredient> ingredients, FluidStackIngredient fluidIngredient, int duration, float minTemp)
        {
            ...
            return new AdvancedPotRecipe(recipeId, ingredients, fluidIngredient, duration, minTemp, output, stacks);
        }

        @Override
        protected AdvancedPotRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer, List<Ingredient> ingredients, FluidStackIngredient fluidIngredient, int duration, float minTemp)
        {
            ...
            return new AdvancedPotRecipe(recipeId, ingredients, fluidIngredient, duration, minTemp, fluid, stacks);
        }
    }
}
