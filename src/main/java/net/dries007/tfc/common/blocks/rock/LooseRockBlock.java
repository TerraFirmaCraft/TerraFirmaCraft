...
public class LooseRockBlock extends GroundcoverBlock implements IFluidLoggable
{
    ...
    public LooseRockBlock(Properties properties)
    {
        ...
        registerDefaultState(getStateDefinition().any().setValue(getFluidProperty(), getFluidProperty().keyFor(Fluids.EMPTY)).setValue(FACING, Direction.EAST).setValue(ROCKS, 1));
    }
    ...
    {
        builder.add(FACING, FLUID, ROCKS);
    }
