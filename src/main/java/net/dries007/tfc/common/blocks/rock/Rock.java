...
public enum Rock implements RegistryRock
{
    ...
    public enum BlockType implements StringRepresentable
    {
        ...
        CRACKED_BRICKS((rock, self) -> new Block(Block.Properties.of(Material.STONE).sound(SoundType.STONE).strength(1.5f, 10).requiresCorrectToolForDrops()), true),
        ...
        MOSSY_COBBLE((rock, self) -> new MossSpreadingBlock(Block.Properties.of(Material.STONE).sound(SoundType.STONE).strength(1.5f, 10).requiresCorrectToolForDrops()), true),
