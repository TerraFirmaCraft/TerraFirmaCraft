...
public enum Rock implements RegistryRock
{
    ...
    public enum BlockType implements StringRepresentable
    {
        ...
        SPIKE((rock, self) -> new RockSpikeBlock(Block.Properties.of(Material.STONE, rock.color()).sound(SoundType.STONE).strength(rock.category().hardness(4f), 10).requiresCorrectToolForDrops()), false),
