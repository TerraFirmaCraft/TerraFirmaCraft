...
public class WeatheringSlabBlock extends SlabBlock implements IWeatheringBlock
{
    private final Age age;
    private final float weatheringResistance;

    public WeatheringSlabBlock(Properties properties, Age age, float weatheringResistance)
    {
