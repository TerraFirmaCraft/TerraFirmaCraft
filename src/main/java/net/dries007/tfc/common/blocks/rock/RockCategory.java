...
public enum RockCategory implements StringRepresentable
{
    ...
    public enum ItemType
    {
        ...
        JAVELIN(rock -> new JavelinItem(rock.getTier(), ToolItem.calculateVanillaAttackDamage(1.0F, rock.getTier()), -1.8F, new Item.Properties().tab(TFCItemGroup.ROCK_STUFFS), "stone")),
