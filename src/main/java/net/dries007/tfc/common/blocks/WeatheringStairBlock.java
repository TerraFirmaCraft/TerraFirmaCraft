...
public class WeatheringStairBlock extends StairBlock implements IWeatheringBlock
{
    ...
    public WeatheringStairBlock(BlockState state, Properties properties, Age age, float weatheringResistance)
    {
        super(state, age == Age.OXIDIZED ? properties : properties.randomTicks());
        this.age = age;
