...
public class BerryBush
{
    ...
    public enum Default
    {
        ...
        BUNCHBERRY(new BerryBush(Type.STATIONARY, TFCItems.BERRIES.get(Berry.BUNCHBERRY), 15f, 30f, 100f, 400f, new SpreadingBushBlock.Lifecycle[] {DORMANT, DORMANT, HEALTHY, HEALTHY, HEALTHY, HEALTHY, FLOWERING, FLOWERING, FRUITING, DORMANT, DORMANT, DORMANT}, 0, 8)),
        CLOUDBERRY(new BerryBush(Type.STATIONARY, TFCItems.BERRIES.get(Berry.CLOUDBERRY), 3f, 17f, 100f, 400f, new SpreadingBushBlock.Lifecycle[] {DORMANT, DORMANT, HEALTHY, HEALTHY, HEALTHY, HEALTHY, FLOWERING, FLOWERING, FRUITING, DORMANT, DORMANT, DORMANT}, 0, 8)),
        STRAWBERRY(new BerryBush(Type.STATIONARY, TFCItems.BERRIES.get(Berry.STRAWBERRY), 5f, 28f, 100f, 400f, new SpreadingBushBlock.Lifecycle[] {DORMANT, DORMANT, HEALTHY, HEALTHY, HEALTHY, HEALTHY, FLOWERING, FLOWERING, FRUITING, DORMANT, DORMANT, DORMANT}, 0, 11)),
        WINTERGREEN_BERRY(new BerryBush(Type.STATIONARY, TFCItems.BERRIES.get(Berry.WINTERGREEN_BERRY), -5f, 17f, 100f, 400f, new SpreadingBushBlock.Lifecycle[] {DORMANT, DORMANT, HEALTHY, HEALTHY, HEALTHY, HEALTHY, FLOWERING, FLOWERING, FRUITING, DORMANT, DORMANT, DORMANT}, 0, 12)),
        CRANBERRY(new BerryBush(Type.WATERLOGGED, TFCItems.BERRIES.get(Berry.CRANBERRY), -5f, 17f, 100f, 400f, new SpreadingBushBlock.Lifecycle[] {DORMANT, DORMANT, HEALTHY, HEALTHY, HEALTHY, HEALTHY, FLOWERING, FLOWERING, FRUITING, DORMANT, DORMANT, DORMANT}, 0, 9));
