...
public class GuiCustomizeWorld extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder
{
    ...
    private static final int ID_SMALL_ROCK = 109;
    ...
    public void initGui()
    {
        ...
        GuiPageButtonList.GuiListEntry[] page1 = new GuiPageButtonList.GuiListEntry[] {
            ...
            new GuiPageButtonList.GuiButtonEntry(ID_SMALL_ROCK, I18n.format("createWorld.customize.custom.smallrocklayer"), true, settings.enableSmallRocklayerSize),
    ...
    public void setEntryValue(int id, boolean value)
    {
        switch (id)
        {
            case ID_FLAT_BEDROCK:
                ...
                break;
            case ID_SMALL_ROCK:
                settings.enableSmallRocklayerSize = value;
        }
        update();
    }
