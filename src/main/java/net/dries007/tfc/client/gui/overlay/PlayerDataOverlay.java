	...
	public void render(RenderGameOverlayEvent.Pre event)
	{
		...
		if (mc.playerController.gameIsSurvivalOrAdventure())
		{
			...
			while (surplusPercent > 0)
			{
				...
				surplusPercent -= 1.0f;
				uSurplus = uSurplus == 90 ? 0 : 90; // To alternate between red and yellow bars (if mods adds that much surplus
													// health)
				// To anyone seeing this: feel free to make a colorize(Hue tweaking?) function
				// to get other color bars
			...
			// Draw experience bar when not riding anything, riding a non-living entity such
			// as a boat/minecart, or riding a pig.
