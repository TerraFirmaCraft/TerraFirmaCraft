...
public class GuiBarrel extends GuiContainerTFC
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        {
            FluidStack fluid = ((ContainerBarrel) inventorySlots).getFluidTank().getTankProperties()[0].getContents();
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        IFluidTankProperties t = ((ContainerBarrel)inventorySlots).getFluidTank().getTankProperties()[0];
