        ...
        .addAnimation("legR",
            new AnimationChannel(AnimationChannel.Targets.ROTATION,
                ...
                new Keyframe(0.25f, KeyframeAnimations.degreeVec(20f, 0f, 0f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(0.75f, KeyframeAnimations.degreeVec(-20.13158f, 0f, 0f),
                    AnimationChannel.Interpolations.LINEAR),
        ...
        .addAnimation("neck",
            new AnimationChannel(AnimationChannel.Targets.ROTATION,
                ...
                new Keyframe(0.75f, KeyframeAnimations.degreeVec(10f, 0f, 0f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(1.0417f, KeyframeAnimations.degreeVec(0f, 0f, 1f),
                    AnimationChannel.Interpolations.LINEAR)))
        .addAnimation("head",
            new AnimationChannel(AnimationChannel.Targets.ROTATION,
                new Keyframe(0f, KeyframeAnimations.degreeVec(0f, 0f, 0.5f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(0.25f, KeyframeAnimations.degreeVec(-5f, 0f, 0f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(0.5f, KeyframeAnimations.degreeVec(0f, 0f, -0.5f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(0.75f, KeyframeAnimations.degreeVec(-5f, 0f, 0f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(1.0417f, KeyframeAnimations.degreeVec(0f, 0f, 0.5f),
    ...
    public static final AnimationDefinition GROUSE_STRUT = AnimationDefinition.Builder.withLength(1f).looping()
        .addAnimation("body",
            new AnimationChannel(AnimationChannel.Targets.ROTATION,
                new Keyframe(0f, KeyframeAnimations.degreeVec(20f, 0f, 0f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(0.25f, KeyframeAnimations.degreeVec(19.94548f, 1.29256f, -1.1155f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(0.5f, KeyframeAnimations.degreeVec(19.97f, 0.74f, 0f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(0.75f, KeyframeAnimations.degreeVec(19.98697f, -0.27655f, 1.115f),
                    AnimationChannel.Interpolations.LINEAR),
        ...
        .addAnimation("neck",
            new AnimationChannel(AnimationChannel.Targets.ROTATION,
                new Keyframe(0f, KeyframeAnimations.degreeVec(-7.5f, 0f, 0f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(0.3333f, KeyframeAnimations.degreeVec(-25f, 0f, 0f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(0.5f, KeyframeAnimations.degreeVec(-7.5f, 0f, 0f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(0.8333f, KeyframeAnimations.degreeVec(-25f, 0f, 0f),
                    AnimationChannel.Interpolations.LINEAR),
        ...
        .addAnimation("neck1",
            new AnimationChannel(AnimationChannel.Targets.ROTATION,
                ...
                new Keyframe(0.5f, KeyframeAnimations.degreeVec(-15f, 0f, 0f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(0.8333f, KeyframeAnimations.degreeVec(-10f, 0f, 0f),
                    AnimationChannel.Interpolations.LINEAR),
        ...
        .addAnimation("head",
            new AnimationChannel(AnimationChannel.Targets.ROTATION,
                ...
                new Keyframe(0.5f, KeyframeAnimations.degreeVec(20f, 0f, 0f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(0.8333f, KeyframeAnimations.degreeVec(30f, 0f, 0f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(1f, KeyframeAnimations.degreeVec(20f, 0f, 0f),
                    AnimationChannel.Interpolations.LINEAR)))
        .addAnimation("tail",
        ...
        .addAnimation("feather_0",
            new AnimationChannel(AnimationChannel.Targets.ROTATION,
                new Keyframe(0f, KeyframeAnimations.degreeVec(76.44921f, -4.86546f, 3.73307f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(1f, KeyframeAnimations.degreeVec(76.44921f, -4.86546f, 3.73307f),
                    AnimationChannel.Interpolations.LINEAR)))
        ...
        .addAnimation("feather_9",
            new AnimationChannel(AnimationChannel.Targets.ROTATION,
                new Keyframe(0f, KeyframeAnimations.degreeVec(82.31794f, -4.76697f, 2.76583f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(1f, KeyframeAnimations.degreeVec(82.31794f, -4.76697f, 2.76583f),
                    AnimationChannel.Interpolations.LINEAR)))
        ...
        .addAnimation("feather_10",
            new AnimationChannel(AnimationChannel.Targets.ROTATION,
                new Keyframe(0f, KeyframeAnimations.degreeVec(76.49255f, 2.25804f, -3.66786f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(1f, KeyframeAnimations.degreeVec(76.49255f, 2.25804f, -3.66786f),
                    AnimationChannel.Interpolations.LINEAR)))
        .addAnimation("snood",
            new AnimationChannel(AnimationChannel.Targets.ROTATION,
                new Keyframe(0f, KeyframeAnimations.degreeVec(0f, 0f, 0f),
        ...
        .addAnimation("wingL",
            new AnimationChannel(AnimationChannel.Targets.ROTATION,
                new Keyframe(0f, KeyframeAnimations.degreeVec(-22.5f, 10f, 0f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(0.5f, KeyframeAnimations.degreeVec(-31.59154f, 21.1933f, -5.728f),
                    AnimationChannel.Interpolations.LINEAR),
        ...
        .addAnimation("wingR",
            new AnimationChannel(AnimationChannel.Targets.ROTATION,
                new Keyframe(0f, KeyframeAnimations.degreeVec(-22.5f, -10f, 0f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(0.4583f, KeyframeAnimations.degreeVec(-31.59154f, -21.19328f, 5.72796f),
                    AnimationChannel.Interpolations.LINEAR),
                new Keyframe(1f, KeyframeAnimations.degreeVec(-22.5f, -10f, 0f),
                    AnimationChannel.Interpolations.LINEAR))).build();
