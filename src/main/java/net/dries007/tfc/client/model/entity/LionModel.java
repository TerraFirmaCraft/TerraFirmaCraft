...
public class LionModel extends FelinePredatorModel<FelinePredator>
{
    ...
    public static final AnimationDefinition SLEEP = AnimationDefinition.Builder.withLength(2.0F).looping()
        .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, new Vector3f(15F, 0F, 0F), AnimationChannel.Interpolations.LINEAR), new Keyframe(1.0F, new Vector3f(12.5F, 0F, 0F), AnimationChannel.Interpolations.LINEAR), new Keyframe(2.0F, new Vector3f(15F, 0F, 0F), AnimationChannel.Interpolations.LINEAR)))
        .addAnimation("tail", new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, new Vector3f(-30F, 0F, 0F), AnimationChannel.Interpolations.LINEAR), new Keyframe(2.0F, new Vector3f(-30F, 0F, 0F), AnimationChannel.Interpolations.LINEAR)))
        .addAnimation("tail1", new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, new Vector3f(2.5F, 0F, 0F), AnimationChannel.Interpolations.LINEAR), new Keyframe(2.0F, new Vector3f(2.5F, 0F, 0F), AnimationChannel.Interpolations.LINEAR)))
        .addAnimation("right_front_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, new Vector3f(-90F, 0F, 0F), AnimationChannel.Interpolations.LINEAR), new Keyframe(2.0F, new Vector3f(-90F, 0F, 0F), AnimationChannel.Interpolations.LINEAR)))
        .addAnimation("left_front_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, new Vector3f(-90F, 0F, 0F), AnimationChannel.Interpolations.LINEAR), new Keyframe(2.0F, new Vector3f(-90F, 0F, 0F), AnimationChannel.Interpolations.LINEAR)))
        .addAnimation("left_hind_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, new Vector3f(-90F, -5F, 0F), AnimationChannel.Interpolations.LINEAR), new Keyframe(2.0F, new Vector3f(-90F, -5F, 0F), AnimationChannel.Interpolations.LINEAR)))
        .addAnimation("right_hind_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, new Vector3f(-90F, 5F, 0F), AnimationChannel.Interpolations.LINEAR), new Keyframe(2.0F, new Vector3f(-90F, 5F, 0F), AnimationChannel.Interpolations.LINEAR)))
        .build();
