...
public class SabertoothModel extends FelinePredatorModel<FelinePredator>
{
    ...
    public static final AnimationDefinition SLEEP = AnimationDefinition.Builder.withLength(3.0F).looping()
        .addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, new Vector3f(2.5F, 0F, 0F), AnimationChannel.Interpolations.LINEAR), new Keyframe(1.5F, new Vector3f(5F, 0F, 0F), AnimationChannel.Interpolations.LINEAR), new Keyframe(3.0F, new Vector3f(2.5F, 0F, 0F), AnimationChannel.Interpolations.LINEAR)))
        .addAnimation("neck", new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, new Vector3f(10F, 0F, 0F), AnimationChannel.Interpolations.LINEAR), new Keyframe(3.0F, new Vector3f(10F, 0F, 0F), AnimationChannel.Interpolations.LINEAR)))
        .addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, new Vector3f(32.5F, 0F, 0F), AnimationChannel.Interpolations.LINEAR), new Keyframe(3.0F, new Vector3f(32.5F, 0F, 0F), AnimationChannel.Interpolations.LINEAR)))
        .addAnimation("right_front_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, new Vector3f(-82.49294F, -2.4786F, -0.32652F), AnimationChannel.Interpolations.LINEAR), new Keyframe(1.5F, new Vector3f(-84.99294F, -2.4786F, -0.32652F), AnimationChannel.Interpolations.LINEAR), new Keyframe(3.0F, new Vector3f(-82.49294F, -2.4786F, -0.32652F), AnimationChannel.Interpolations.LINEAR)))
        .addAnimation("left_front_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, new Vector3f(-82.47168F, 4.95712F, 0.65426F), AnimationChannel.Interpolations.LINEAR), new Keyframe(1.5F, new Vector3f(-84.97168F, 4.95712F, 0.65426F), AnimationChannel.Interpolations.LINEAR), new Keyframe(3.0F, new Vector3f(-82.47168F, 4.95712F, 0.65426F), AnimationChannel.Interpolations.LINEAR)))
        .addAnimation("rear", new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, new Vector3f(-17.5F, 0F, 0F), AnimationChannel.Interpolations.LINEAR), new Keyframe(3.0F, new Vector3f(-17.5F, 0F, 0F), AnimationChannel.Interpolations.LINEAR)))
        .addAnimation("left_hind_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, new Vector3f(-77.25431F, -12.26424F, -2.42F), AnimationChannel.Interpolations.LINEAR), new Keyframe(1.5F, new Vector3f(-79.75431F, -12.26424F, -2.42F), AnimationChannel.Interpolations.LINEAR), new Keyframe(3.0F, new Vector3f(-77.25431F, -12.26424F, -2.42F), AnimationChannel.Interpolations.LINEAR)))
        .addAnimation("right_hind_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, new Vector3f(-77.20638F, 12.19908F, 2.74715F), AnimationChannel.Interpolations.LINEAR), new Keyframe(1.5F, new Vector3f(-84.97168F, 4.95712F, 0.65426F), AnimationChannel.Interpolations.LINEAR), new Keyframe(3.0F, new Vector3f(-77.20638F, 12.19908F, 2.74715F), AnimationChannel.Interpolations.LINEAR)))
        .addAnimation("earR", new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, new Vector3f(0f, 0f, 0f), AnimationChannel.Interpolations.LINEAR), new Keyframe(2.875F, new Vector3f(0f, 0f, 0f), AnimationChannel.Interpolations.LINEAR), new Keyframe(2.9583F, new Vector3f(26.44409F, -5.44303F, 11.3489F), AnimationChannel.Interpolations.LINEAR), new Keyframe(3.0F, new Vector3f(0f, 0f, 0f), AnimationChannel.Interpolations.LINEAR)))
        .build();
