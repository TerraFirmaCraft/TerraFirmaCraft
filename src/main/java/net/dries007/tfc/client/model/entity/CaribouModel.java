...
public class CaribouModel extends HierarchicalAnimatedModel<Prey> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_hind_leg = caribou.addOrReplaceChild("left_hind_leg", CubeListBuilder.create(), PartPose.offset(-7.0F, -38.9634F, 0.8335F));

		PartDefinition cube_r16 = left_hind_leg.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(61, 77).addBox(-5.25F, -39.0F, -20.5F, 3.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, 42.9634F, 26.1665F, 0.0F, 0.0F, 0.0F));

		PartDefinition cube_r17 = left_hind_leg.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(52, 0).addBox(-6.0F, -8.9699F, -7.5488F, 4.0F, 7.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, -1.0366F, 2.1665F, -1.8326F, 0.0F, 0.0F));

		PartDefinition left_front_leg = caribou.addOrReplaceChild("left_front_leg", CubeListBuilder.create(), PartPose.offset(-6.0F, -42.9128F, 30.7086F));

		PartDefinition bone3 = left_front_leg.addOrReplaceChild("bone3", CubeListBuilder.create(), PartPose.offset(-3.0F, -2.0872F, 0.2914F));
		...
		PartDefinition right_front_leg = caribou.addOrReplaceChild("right_front_leg", CubeListBuilder.create(), PartPose.offset(7.0F, -42.9128F, 30.7086F));
		...
		PartDefinition right_back_leg = caribou.addOrReplaceChild("right_back_leg", CubeListBuilder.create(), PartPose.offset(7.0F, -38.9634F, 0.8335F));

		PartDefinition cube_r22 = right_back_leg.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(34, 0).addBox(-9.75F, -39.0F, -20.5F, 3.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0F, 42.9634F, 26.1665F, 0.0F, 0.0F, 0.0F));

		PartDefinition cube_r23 = right_back_leg.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(40, 40).addBox(3.0F, -8.9699F, -7.5488F, 4.0F, 7.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.0F, -1.0366F, 2.1665F, -1.8326F, 0.0F, 0.0F));
