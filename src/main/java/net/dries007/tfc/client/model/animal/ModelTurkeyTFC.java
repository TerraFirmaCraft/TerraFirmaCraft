...
public class ModelTurkeyTFC extends ModelBase
{
    ...
    public ModelTurkeyTFC()
    {
        ...
        thingy.setRotationPoint(-1.0F, -1.0F, 0.8F);
    ...
    public void render(@Nonnull Entity entity, float par2, float par3, float par4, float par5, float par6, float par7)
    {
        ...
        if (turkey.getGender() == EntityAnimalTFC.Gender.FEMALE)
        {
            setRotateAngle(tails1, -1.6390387005478748F, -0.17453292519943295F, -1.3089969389957472F);
            setRotateAngle(tails2, -1.6845917940249266F, -0.13962634015954636F, -1.0471975511965976F);
            setRotateAngle(tails3, -1.8212510744560826F, -0.10471975511965977F, -0.7853981633974483F);
            setRotateAngle(tails4, -1.8212510744560826F, -0.06981317007977318F, -0.5235987755982988F);
            setRotateAngle(tails5, -1.9577358219620393F, -0.03490658503988659F, -0.2617993877991494F);
            setRotateAngle(tails6, -1.8668041679331349F, 0.0F, 0.0F);
            setRotateAngle(tails7, -1.8212510744560826F, 0.03490658503988659F, 0.2617993877991494F);
            setRotateAngle(tails8, -1.9123572614101867F, 0.06981317007977318F, 0.5235987755982988F);
            setRotateAngle(tails9, -1.7756979809790308F, 0.10471975511965977F, 0.7853981633974483F);
            setRotateAngle(tails10, -1.7756979809790308F, 0.13962634015954636F, 1.0471975511965976F);
            setRotateAngle(tails11, -1.730144887501979F, 0.17453292519943295F, 1.3089969389957472F);
            tails1.setRotationPoint(-2.0F, 14.0F, 5.0F);
            tails2.setRotationPoint(-2.0F, 14.0F, 5.0F);
            tails3.setRotationPoint(-1.0F, 13.0F, 5.0F);
            tails4.setRotationPoint(0.0F, 13.0F, 5.0F);
            tails5.setRotationPoint(0.0F, 13.0F, 5.0F);
            tails6.setRotationPoint(0.0F, 13.0F, 5.0F);
            tails7.setRotationPoint(0.0F, 12.0F, 5.0F);
            tails8.setRotationPoint(1.0F, 14.0F, 5.0F);
            tails9.setRotationPoint(1.0F, 15.0F, 5.0F);
            tails10.setRotationPoint(2.0F, 13.0F, 5.0F);
