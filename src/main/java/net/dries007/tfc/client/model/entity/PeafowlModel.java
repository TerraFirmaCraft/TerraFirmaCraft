...
public class PeafowlModel extends HierarchicalAnimatedModel<WingedPrey>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        PartDefinition legR = body.addOrReplaceChild("legR", CubeListBuilder.create().texOffs(16, 4).addBox(-1.5F, -0.0834F, -1.409F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition legL = body.addOrReplaceChild("legL", CubeListBuilder.create().texOffs(0, 12).addBox(0.5F, -0.0834F, -1.409F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition main_r1 = wingL.addOrReplaceChild("main_r1", CubeListBuilder.create().texOffs(0, 12).addBox(0.0F, -4.0F, 0.0F, 1.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, -1.0F, -0.0873F, 0.0F, 0.0F));
        ...
        PartDefinition main_r2 = wingR.addOrReplaceChild("main_r2", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -4.0F, 0.0F, 1.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, -1.0F, -0.0873F, 0.0F, 0.0F));
