...
public enum DoubleIngotPileBlockModel implements IBakedGeometry<DoubleIngotPileBlockModel>, IStaticBakedModel
{
    INSTANCE;
    ...
    private StaticModelData renderIngotPileGeometry(BlockAndTintGetter level, BlockPos pos, BlockState state, IngotPileBlockEntity pile)
    {
        ...
        final int ingots = state.getValue(DoubleIngotPileBlock.DOUBLE_COUNT);
