...
/**
 * ModelMongooseTFC - Either Mojang or a mod author
...
public class ModelMongooseTFC extends ModelBase
{
    ...
    public ModelMongooseTFC()
    {
        ...
        legRFrontLower.setRotationPoint(-1.0F, 3.5F, 0.5F);
        legRFrontLower.addBox(0.0F, 0.0F, 0.0F, 2, 4, 2, 0.0F);
        legLFront = new ModelRenderer(this, 14, 25);
        legLFront.mirror = true;
        legLFront.setRotationPoint(2.5F, 16.5F, -6.0F);
        legLFront.addBox(-1.0F, 0.0F, 0.0F, 2, 4, 3, 0.0F);
        legLBackPaw = new ModelRenderer(this, 27, 17);
        legLBackPaw.mirror = true;
        legLBackPaw.setRotationPoint(0.0F, 2.0F, -0.5F);
        legLBackPaw.addBox(0.0F, 0.0F, 0.0F, 2, 1, 1, 0.0F);
        ...
        legRFront.setRotationPoint(-2.5F, 16.5F, -6.0F);
        legRFront.addBox(-1.0F, 0.0F, 0.0F, 2, 4, 3, 0.0F);
        legRBackPaw = new ModelRenderer(this, 27, 17);
        legRBackPaw.setRotationPoint(0.0F, 2.0F, -0.5F);
        legRBackPaw.addBox(0.0F, 0.0F, 0.0F, 2, 1, 1, 0.0F);
        ...
        legRBackLower.setRotationPoint(-1.0F, 5.0F, 1.5F);
        legRBackLower.addBox(0.0F, 0.0F, 0.0F, 2, 3, 2, 0.0F);
        ...
        legLFrontLower.setRotationPoint(-1.0F, 3.5F, 0.5F);
        legLFrontLower.addBox(0.0F, 0.0F, 0.0F, 2, 4, 2, 0.0F);
        ...
        legLBack.setRotationPoint(2.7F, 16.0F, 2.5F);
        legLBack.addBox(-1.0F, 0.0F, 1.0F, 2, 5, 3, 0.0F);
        legRBack = new ModelRenderer(this, 25, 24);
        legRBack.setRotationPoint(-2.7F, 16.0F, 2.5F);
        legRBack.addBox(-1.0F, 0.0F, 1.0F, 2, 5, 3, 0.0F);
        legRFrontPaw = new ModelRenderer(this, 16, 17);
        legRFrontPaw.setRotationPoint(0.0F, 3.0F, -0.5F);
        legRFrontPaw.addBox(0.0F, 0.0F, 0.0F, 2, 1, 1, 0.0F);
