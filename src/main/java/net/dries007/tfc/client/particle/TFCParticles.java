...
public enum TFCParticles
{
    ...
    FIRE_PIT_SMOKE(new ResourceLocation(MOD_ID, "particle/fire_pit_smoke"), ParticleFirePitSmoke::new);
    ...
    private final IParticleFactoryTFC factory;
     ...
     * @param factory  the method to create new instances of this particle
     */
    TFCParticles(ResourceLocation location, IParticleFactoryTFC factory)
    {
    ...
    {
        Particle particle = factory.createParticle(worldIn, x, y, z, speedX, speedY, speedZ, duration);
