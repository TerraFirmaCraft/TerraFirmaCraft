...
public class TESRLargeVessel extends TileEntitySpecialRenderer<TELargeVessel>
{

    @Override
    public void render(TELargeVessel te, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
        ...
        {
            GlStateManager.pushMatrix();
            GlStateManager.translate(0.5D, 0.0625D, 0.5D);
        ...
        if (fluidStack != null)
        {
            ...
            double height = 0.0625D + (0.5D) * content.amount / properties.getCapacity();
