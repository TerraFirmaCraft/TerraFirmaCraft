...
public class TESRLoom extends TESRBase<TELoom>
{
	...
	{
		return new double[][] { { X1, Y1, Z1, texX1, texY1 }, { X2, Y1, Z1, texX2, texY1 }, { X2, Y2, Z2, texX2, texY2 }, { X1, Y2, Z2, texX1, texY2 },

				{ X2, Y1, Z1, texX2, texY1 }, { X1, Y1, Z1, texX1, texY1 }, { X1, Y2, Z2, texX1, texY2 }, { X2, Y2, Z2, texX2, texY2 } };
	}
