...
public class NutritionScreen extends TFCContainerScreen<SimpleContainer>
{
    ...
    public void init()
    {
        ...
        addButton(new PlayerInventoryTabButton(guiLeft, guiTop, 176, 27, 20, 22, 96, 0, 1, 3, 32, 0, button -> {
            PacketHandler.send(PacketDistributor.SERVER.noArg(), new SwitchInventoryTabPacket(SwitchInventoryTabPacket.Type.CALENDAR));
        }));
        addButton(new PlayerInventoryTabButton(guiLeft, guiTop, 176 - 3, 50, 20 + 3, 22, 96 + 20, 0, 1, 3, 64, 0, button -> {
