...
public class ClimateScreen extends TFCContainerScreen<SimpleContainer>
{
    ...
    protected void renderHoveredTooltip(MatrixStack matrixStack, int mouseX, int mouseY)
    {
        ...
        String plateTectonics = I18n.format("tfc.tooltip.climate_plate_tectonics_classification") + I18n.format(Helpers.getEnumTranslationKey(ClimateRenderCache.INSTANCE.getPlateTectonicsInfo()));
        ...
        font.drawString(matrixStack, climateType, (width - font.getStringWidth(climateType)) / 2f, 25, 0x404040);
        font.drawString(matrixStack, plateTectonics, (width - font.getStringWidth(plateTectonics)) / 2f, 34, 0x404040);
        font.drawString(matrixStack, averageTempTooltip, (width - font.getStringWidth(averageTempTooltip)) / 2f, 43, 0x404040);
        font.drawString(matrixStack, rainfallTooltip, (width - font.getStringWidth(rainfallTooltip)) / 2f, 52, 0x404040);
        font.drawString(matrixStack, currentTempTooltip, (width - font.getStringWidth(currentTempTooltip)) / 2f, 61, 0x404040);
    }
