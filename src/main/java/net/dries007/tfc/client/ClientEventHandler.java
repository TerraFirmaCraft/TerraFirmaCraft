...
public final class ClientEventHandler
{
    ...
    public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event)
    {
        ...
        event.registerEntityRenderer(TFCEntities.BONGO.get(), ctx -> new SimpleMobRenderer.Builder<>(ctx, BongoModel::new, "bongo").shadow(0.6f).hasBabyTexture().build());
        event.registerEntityRenderer(TFCEntities.CARIBOU.get(), ctx -> new SimpleMobRenderer.Builder<>(ctx, CaribouModel::new, "caribou").shadow(0.6f).hasBabyTexture().build());
        ...
        event.registerEntityRenderer(TFCEntities.GAZELLE.get(), ctx -> new SimpleMobRenderer.Builder<>(ctx, GazelleModel::new, "gazelle").shadow(0.6f).hasBabyTexture().build());
        ...
        event.registerEntityRenderer(TFCEntities.PHEASANT.get(), ctx -> new SimpleMobRenderer.Builder<>(ctx, PeafowlModel::new, "peafowl").shadow(0.5f).texture(e -> Helpers.getGenderedTexture(e, "peafowl")).build());
        ...
        event.registerEntityRenderer(TFCEntities.PEAFOWL.get(), ctx -> new SimpleMobRenderer.Builder<>(ctx, TurkeyModel::new, "turkey").shadow(0.5f).texture(e -> Helpers.getGenderedTexture(e, "turkey")).build());
