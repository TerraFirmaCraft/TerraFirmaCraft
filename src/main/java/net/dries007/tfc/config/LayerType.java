...
{
    SIN_X((seed, scale) -> new SinNoise(1, 0, 1f / scale, 0).extendX().add(new SimplexNoise2D(seed).octaves(2).spread(12f / scale).scaled(-0.2f, 0.2f))),
    SIN_Z((seed, scale) -> new SinNoise(1, 0, 1f / scale, 0).extendY().add(new SimplexNoise2D(seed).octaves(2).spread(12f / scale).scaled(-0.2f, 0.2f))),
