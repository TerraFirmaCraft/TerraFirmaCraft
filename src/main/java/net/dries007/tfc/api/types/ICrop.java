...
/**
 * This is the "model" that is used by BlockCropTFC In vanilla TFC, they are all
 * used as Crop enum instances
 */
public interface ICrop
{
	...
	/**
	 * @return the maximum stage of growth (when current stage == max stage, the
	 *         crop is fully grown)
	 */
	int getMaxStage();
	...
	/**
	 * A stricter version of the above check. Allows the crop to grow (advance in
	 * stages)
	 *
	 * @param temperature the temperature, in -30 - +30
	 * @param rainfall    the rainfall, in 0 - 500
