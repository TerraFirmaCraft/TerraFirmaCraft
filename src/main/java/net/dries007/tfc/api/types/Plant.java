...
public class Plant extends IForgeRegistryEntry.Impl<Plant>
{
	...
	/**
	 * Addon mods that want to add plants should subscribe to the registry event for
	 * this class They also must put (in their mod) the required resources in
	 * /assets/tfc/...
	 *
	 * Plant world generation is determined dynamically based on valid temperature
	 * and rainfall values
	 *
	 * Valid average biome temperatures are those that fall within the range plus or
	 * minus one quarter of the plants full temperature range
	 *
	 * Example: Lotus Full temperature range: 10-50 Average temp: 30 ( (10+50)/2 )
	 * Difference between max and min temps: 40 (50-10) One quarter of this range:
	 * 10 (40/4) Worldgen temp range: 20-40 (30 +- 10)
	 *
	...
	{
		COLD, HOT, DRY, WET, VALID
	}

	// todo: switch usages to interface from enum, it will make custom plants by
	// addons easier down the line. It's also a better design
	public enum PlantType implements IPlantType
	{
		STANDARD(BlockPlantTFC::new), TALL_PLANT(BlockTallPlantTFC::new), CREEPING(BlockCreepingPlantTFC::new), HANGING(BlockHangingPlantTFC::new), FLOATING(BlockFloatingWaterTFC::new), FLOATING_SEA(BlockFloatingWaterTFC::new), DESERT(BlockPlantTFC::new), DESERT_TALL_PLANT(BlockTallPlantTFC::new), DRY(BlockPlantTFC::new), DRY_TALL_PLANT(BlockTallPlantTFC::new), CACTUS(BlockCactusTFC::new), SHORT_GRASS(BlockShortGrassTFC::new), TALL_GRASS(BlockTallGrassTFC::new), EPIPHYTE(BlockEpiphyteTFC::new), REED(BlockPlantTFC::new), REED_SEA(BlockPlantTFC::new), TALL_REED(BlockTallPlantTFC::new), TALL_REED_SEA(BlockTallPlantTFC::new), WATER(BlockWaterPlantTFC::new), WATER_SEA(BlockWaterPlantTFC::new), TALL_WATER(BlockTallWaterPlantTFC::new), TALL_WATER_SEA(BlockTallWaterPlantTFC::new), EMERGENT_TALL_WATER(BlockEmergentTallWaterPlantTFC::new), EMERGENT_TALL_WATER_SEA(BlockEmergentTallWaterPlantTFC::new), MUSHROOM(BlockMushroomTFC::new);
	...
	{
		CLAY, DESERT_CLAY, DRY_CLAY, DRY, FRESH_BEACH, SALT_BEACH, FRESH_WATER, SALT_WATER, NONE;
