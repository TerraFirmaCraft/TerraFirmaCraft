...
{
	/**
	 * @return the minimum time the bush will take to grow one bush/fruit ripe (in
	 *         hours)
	 */
	float getGrowthTime();
	...
	/**
	 * A stricter version of the above check. Allows the bush to grow
	 * fruits/adjacent bushes
	 *
	 * @param temperature the temperature, in -30 - +30
	 * @param rainfall    the rainfall, in 0 - 500
