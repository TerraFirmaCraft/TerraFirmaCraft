...
public class Rock extends IForgeRegistryEntry.Impl<Rock>
{
	...
	{
		AXE(ItemRockAxe::new, " X   ", "XXXX ", "XXXXX", "XXXX ", " X   "), SHOVEL(ItemRockShovel::new, "XXX", "XXX", "XXX", "XXX", " X "), HOE(ItemRockHoe::new, "XXXXX", "   XX"), KNIFE(ItemRockKnife::new, "X ", "XX", "XX", "XX", "XX"), JAVELIN(ItemRockJavelin::new, "XXX  ", "XXXX ", "XXXXX", " XXX ", "  X  "), HAMMER(ItemRockHammer::new, "XXXXX", "XXXXX", "  X  ");
	...
	public enum Type
	{
		RAW(Material.ROCK, FALL_VERTICAL, false, BlockRockRaw::new), SMOOTH(Material.ROCK, NO_FALL, false), COBBLE(Material.ROCK, FALL_HORIZONTAL, false), BRICKS(Material.ROCK, NO_FALL, false), SAND(Material.SAND, FALL_HORIZONTAL, false), GRAVEL(Material.SAND, FALL_HORIZONTAL, false), DIRT(Material.GROUND, FALL_HORIZONTAL, false), GRASS(Material.GRASS, FALL_HORIZONTAL, true), DRY_GRASS(Material.GRASS, FALL_HORIZONTAL, true), CLAY(Material.CLAY, FALL_VERTICAL, false), CLAY_GRASS(Material.GRASS, FALL_VERTICAL, true), FARMLAND(Material.GROUND, FALL_VERTICAL, false, BlockFarmlandTFC::new), PATH(Material.GROUND, FALL_VERTICAL, false, BlockPathTFC::new);
		...
		{
			// If no fall + no grass, then normal. If it can fall, then eiether fallable or
			// fallable + connected (since grass always falls)
			this(material, gravType, isGrass, (gravType == NO_FALL && !isGrass) ? BlockRockVariant::new : (isGrass ? BlockRockVariantConnected::new : BlockRockVariantFallable::new));
		}
	...
	{
		NO_FALL, FALL_VERTICAL, FALL_HORIZONTAL
	}
}
