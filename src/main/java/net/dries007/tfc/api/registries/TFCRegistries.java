...
{
	/**
	 * To developers: If you are considering creating one of these pre-block
	 * registries, take a minute to ask "is this the best idea" i.e create an
	 * interface + enum, so addons register their own instances of TFC block classes
	 * using a custom implementation of the enum - AlcatrazEscapee
	 */
