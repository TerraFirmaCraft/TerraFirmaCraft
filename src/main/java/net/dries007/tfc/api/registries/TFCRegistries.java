...
{
    public static final ForgeRegistry<Rock> ROCKS = (ForgeRegistry<Rock>) RegistryManager.ACTIVE.getRegistry(Rock.class);
    ...
    static
    {
        ...
        try
        {
            ...
            {
                if (!(field.getType().isAssignableFrom(IForgeRegistry.class) || field.getType().isAssignableFrom(ForgeRegistry.class)))
                {
