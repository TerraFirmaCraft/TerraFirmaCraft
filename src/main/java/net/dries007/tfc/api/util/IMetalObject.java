...
{
	/**
	 * Adds metal info to the item stack This is only shown when advanced item
	 * tooltips is enabled
	 *
	...
	/**
	 * @param stack the item stack. This can assume that it is of the right item
	 *              type and do casts without checking
	...
	/**
	 * @param stack The item stack
	 * @return the amount of liquid metal that this item will create (in TFC units
	 *         or mB: 1 unit = 1 mB)
	 */
