 ...
 * and must provide an offset for them to check by calling
...
public interface IBellowsConsumerBlock
{
	...
	/**
	 * standard handlers should check if they have been accessed by belows from a
	 * legal offset
	 *
	 * @param te     bellows that query
	 * @param offset that the bellows used to reach this block, NOT ROTATED
	 *               accordingly!
	 ...
	 * @param airAmount the amount of air that the bellows give. For reference, TFC
	 *                  bellows always give 200.
	 */
