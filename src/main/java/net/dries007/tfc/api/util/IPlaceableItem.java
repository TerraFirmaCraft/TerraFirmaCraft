...
{
	/**
	 * When an item that implements IPlaceableItem is right clicked, this will be
	 * called to invoke special placement logic Implement this if you want a custom
	 * item block that might need to subclass another item class
	 *
	 ...
	 * @return if the block was placed (will consume one item from the player's
	 *         item)
	 */
	...
	/**
	 * This will be called after a successful placement. If this is nonzero, the
	 * player will consume that amount from their held item.
	 *
	...
	class Impl
	{
		...
		// Add to this map for things that fire when you right click in the air OR when
		// you right click a block
