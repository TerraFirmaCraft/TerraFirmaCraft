...
public class FoodStatsTFC extends FoodStats implements IFoodStatsTFC
{
	...
	{
		// In TFC, all foods have a constant amount of food filled (In 1.7.10 this was
		// 5oz, out of a 24 oz stomach.) We will go with real units, and just make this
		// 1/5 of the sourcePlayer's food bar (4 haunches)
		// However, old vanilla foods have a bonus to their saturation based on their
		// hunger value
		// Vanilla foods are generally in the range 0.0 - 1.0 for saturation, and 1 - 8
		// for hunger
	...
	public void onUpdate(EntityPlayer player)
	{
		...
		// Since this is only called server side, and vanilla has a custom packet for
		// this stuff, we need our own
	...
	{
		return this.thirst < MAX_PLAYER_THIRST;
	}
	...
	/**
	 * Sets the nutrient value directly. Used by command nutrients and for debug
	 * purposes
	 *
