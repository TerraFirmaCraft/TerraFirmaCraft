...
/**
 * This is an interface for the capability that is returned by a Small Vessel.
 * You can safely cast it to this.
 */
public interface ISmallVesselHandler extends IItemHandlerModifiable, IFluidHandler, INBTSerializable<NBTTagCompound>, IItemHeat, IMoldHandler
{
	 ...
	 *
	 * @return INVENTORY = items, LIQUID = fluids molten or solid based on
	 *         temperature
	 */
	Mode getFluidMode();
	...
	enum Mode
	{
		INVENTORY, LIQUID_MOLTEN, LIQUID_SOLID
	}
