...
public final class CapabilityItemSize
{
	...
	/**
	 * Adds a simple IItemSize capability to an item instance. Call this from an
	 * AttachCapabilitiesEvent handler. This will also override the item's
	 * stacksize. If an item uses a custom getStacksize implementation, that will
	 * take priority
	 *
	...
	/**
	 * Gets the IItemSize instance from an itemstack, either via capability or via
	 * interface
	 *
