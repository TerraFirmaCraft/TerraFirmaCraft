...
public class FoodHandler implements IFood, ICapabilitySerializable<NBTTagCompound>
{
	...
	{
		// This avoids overflow which breaks when calculateDecayModifier() returns
		// infinity, which happens if decay modifier = 0
	...
	public void deserializeNBT(@Nullable NBTTagCompound nbt)
	{
		...
		} else
		{
			...
			// Food decay initially is synced with the hour. This allows items grabbed
			// within a minute to stack
