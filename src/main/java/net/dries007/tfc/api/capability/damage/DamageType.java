...
/**
 * Resistances are positive, weaknesses are negative Calculations are done per
 * <a href="https://www.desmos.com/calculator/689oqycw1t">this spreadsheet</a>
 */
@ParametersAreNonnullByDefault
public enum DamageType
{
	CRUSHING, PIERCING, SLASHING, GENERIC;
	...
	public static float getModifier(DamageSource source, EntityLivingBase entityUnderAttack)
	{
		...
		{
			// Apply damage type specific resistances, from the entity under attack and from
			// their armor
			{
