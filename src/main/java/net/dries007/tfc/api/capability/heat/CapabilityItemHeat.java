...
public final class CapabilityItemHeat
{
	...
	/**
	 * For most practical purposes this is the max temperature than an item should
	 * reach. i.e. all metals should melt either before this, or never.
	 */
	 ...
	 *
	 * @param modifier the modifier for how much this will heat up: 0 - 1 slows down
	 *                 cooling, 1 = no heating or cooling, > 1 heats, 2 heats at the
