...
public class AnvilRecipeMeasurable extends AnvilRecipe
{
	...
	/*
	 * Use this constructor to make a recipe where only accepts input if it has a
	...
	/*
	 * Use this constructor to build a recipe where the metal amount is copied from
	 * input to output.
	 */
