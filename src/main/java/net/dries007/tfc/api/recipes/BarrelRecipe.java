...
public class BarrelRecipe extends IForgeRegistryEntry.Impl<BarrelRecipe>
{
	...
	/**
	 * Called by TEBarrel when a recipe finishes Used if you want to play a sound /
	 * cause an update of some sort
	 *
	 ...
	 *
	 * @return the name of the item stack produced, or the fluid produced, or a
