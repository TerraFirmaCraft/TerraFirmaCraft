...
/**
 * This is an anvil recipe that will split an {@link IForgeableMeasurable} into
 * a specific "chunk" size Used by blooms to split a 560 -> 5x 100 blooms and 1x
 * 60 bloom for example
 */
...
public class AnvilRecipeSplitting extends AnvilRecipeMeasurable
{
	...
	public boolean matches(ItemStack input)
	{
		if (!super.matches(input))
			return false;
		// Splitable if the output is at least two(don't change this or you will have
		// duplicates)
