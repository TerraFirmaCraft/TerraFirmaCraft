...
public class BerryBushProvider implements Function<ITheOneProbe, Void>, IProbeInfoProvider
{
    ...
    public String getID()
    {
        return MOD_ID + ":top_berrybush_provider";
    }
    ...
    {
        {
            if (state.getBlock() instanceof BlockBerryBush)
            {
                ...
                BlockBerryBush b = (BlockBerryBush) state.getBlock();
