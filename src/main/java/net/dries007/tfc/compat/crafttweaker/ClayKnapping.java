...
public class ClayKnapping
{
    ...
    public static void addRecipe(IItemStack output, String... pattern)
    {
        ...
        KnappingRecipe recipe = new KnappingRecipe.Simple(KnappingRecipe.Type.CLAY, true, outputStack, pattern).setRegistryName("crafttweaker", outputStack.getTranslationKey());
    ...
    public static void removeRecipe(IItemStack output)
    {
        ...
        TFCRegistries.KNAPPING.getValuesCollection()
            .stream()
            .filter(x -> x.getType() == KnappingRecipe.Type.CLAY && x.getOutput(ItemStack.EMPTY).isItemEqual(item))
    ...
    private static class Add implements IAction
    {
        ...
        {
            return "Adding clay knapping recipe for " + recipe.getOutput(ItemStack.EMPTY).getDisplayName();
        }
    }
    ...
    private static class Remove implements IAction
    {
        ...
        public String describe()
        {
            return "Removing clay knapping recipe " + location.toString();
        }
    }
}
