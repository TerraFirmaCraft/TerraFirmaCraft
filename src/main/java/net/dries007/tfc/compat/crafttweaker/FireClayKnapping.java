...
public class FireClayKnapping
{
    ...
    public static void addRecipe(IItemStack output, String... pattern)
    {
        ...
        KnappingRecipe recipe = new KnappingRecipe.Simple(KnappingRecipe.Type.FIRE_CLAY, true, outputStack, pattern).setRegistryName("crafttweaker", outputStack.getTranslationKey());
    ...
    private static class Remove implements IAction
    {
        ...
        public String describe()
        {
            return "Removing fire clay knapping recipe " + location.toString();
        }
    }
}
