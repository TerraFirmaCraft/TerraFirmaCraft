...
public final class JEIIntegration implements IModPlugin
{
    ...
    private static void addRecipeCatalyst(IRecipeCatalystRegistration registry, Ingredient ingredient, RecipeType<?> recipeType)
    {
        for (ItemStack item : ingredient.getItems())
        {
            registry.addRecipeCatalyst(item.copy(), recipeType);
        }
    }
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registry)
    {
        ...
        addRecipeCatalyst(registry, DynamicIngredients.CAN_SCRAPE.ingredient(), SCRAPING);
