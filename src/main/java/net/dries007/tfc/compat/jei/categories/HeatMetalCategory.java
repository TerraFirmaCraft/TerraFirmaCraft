...
import net.dries007.tfc.compat.jei.wrappers.HeatMetalWrapper;

@ParametersAreNonnullByDefault
public class HeatMetalCategory extends BaseRecipeCategory<HeatMetalWrapper>
{
    ...
    public HeatMetalCategory(IGuiHelper helper, String Uid)
    {
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, HeatMetalWrapper recipeWrapper, IIngredients ingredients)
    {
