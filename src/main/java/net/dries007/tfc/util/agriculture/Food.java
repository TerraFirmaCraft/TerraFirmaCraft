...
public enum Food
{
    ...
    BEEF(MEAT, 4, 0f, 0f, 0f, 0f, 0f, 1.5f, 0f, 2f, 1f, 200f),
    PORK(MEAT, 4, 0f, 0f, 0f, 0f, 0f, 1.5f, 0f, 2f, 1f, 200f),
    CHICKEN(MEAT, 4, 0f, 0f, 0f, 0f, 0f, 1.2f, 0f, 3f, 1f, 200f),
    MUTTON(MEAT, 4, 0f, 0f, 0f, 0f, 0f, 1.5f, 0f, 3f, 1f, 200f),
    FISH(MEAT, 4, 0f, 0f, 0f, 0f, 0f, 0.5f, 0f, 3f, 1f, 200f),
    BEAR(MEAT, 4, 0f, 0f, 0f, 0f, 0f, 1.5f, 0f, 2f, 1f, 200f),
    CALAMARI(MEAT, 4, 0f, 0f, 0f, 0f, 0f, 0.5f, 0f, 3f, 1f, 200f),
    HORSE_MEAT(MEAT, 4, 0f, 0f, 0f, 0f, 0f, 1f, 0f, 2f, 1f, 200f),
    PHEASANT(MEAT, 4, 0f, 0f, 0f, 0f, 0f, 0.5f, 0f, 3f, 1f, 200f),
    VENISON(MEAT, 4, 0f, 0f, 0f, 0f, 0f, 1f, 0f, 2f, 1f, 200f),
    WOLF(MEAT, 4, 0f, 0f, 0f, 0f, 0f, 1f, 0f, 3f, 1f, 200f),
    RABBIT(MEAT, 4, 0f, 0f, 0f, 0f, 0f, 0.5f, 0f, 3f, 1f, 200f),
    MONGOOSE(MEAT, 4, 0f, 0f, 0f, 0f, 0f, 1f, 0f, 3f, 1f, 200f),
    GRAN_FELINE(MEAT, 4, 0f, 0f, 0f, 0f, 0f, 1.5f, 0f, 3f, 1f, 200f),
    CAMELIDAE(MEAT, 4, 0f, 0f, 0f, 0f, 0f, 1.5f, 0f, 3f, 1f, 200f),
    ...
    COOKED_FISH(COOKED_MEAT, 4, 1f, 0f, 0f, 0f, 0f, 1.5f, 0f, 2.25f),
    COOKED_BEAR(COOKED_MEAT, 4, 1f, 0f, 0f, 0f, 0f, 2.0f, 0f, 1.5f),
    COOKED_CALAMARI(COOKED_MEAT, 4, 1f, 0f, 0f, 0f, 0f, 1f, 0f, 2.25f),
    COOKED_HORSE_MEAT(COOKED_MEAT, 4, 2f, 0f, 0f, 0f, 0f, 2.5f, 0f, 1.5f),
    COOKED_PHEASANT(COOKED_MEAT, 4, 1f, 0f, 0f, 0f, 0f, 1.5f, 0f, 2.25f),
    COOKED_VENISON(COOKED_MEAT, 4, 1f, 0f, 0f, 0f, 0f, 2f, 0f, 1.5f),
    COOKED_WOLF(COOKED_MEAT, 4, 1f, 0f, 0f, 0f, 0f, 2f, 0f, 2.25f),
    COOKED_RABBIT(COOKED_MEAT, 4, 1f, 0f, 0f, 0f, 0f, 1f, 0f, 2.25f),
    COOKED_MONGOOSE(COOKED_MEAT, 4, 1f, 0f, 0f, 0f, 0f, 1.5f, 0f, 2.25f),
    COOKED_GRAN_FELINE(COOKED_MEAT, 4, 2f, 0f, 0f, 0f, 0f, 2f, 0f, 2.25f),
