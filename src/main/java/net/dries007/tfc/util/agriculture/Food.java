...
public enum Food
{
    ...
    MELON(VEGETABLE, 0.4f, 10f, 0f, 0f, 0f, 1f, 0f, 4f),
    ...
    BEAR(MEAT, 0.8f, 2f, 0f, 2f, 2.5f, 0.5f, 0f, 3f),
    BEEF(MEAT, 0.8f, 2f, 0f, 2f, 2.5f, 0f, 0f, 3f),
    CALAMARI(MEAT, 0.4f, 2f, 0f, 0.5f, 1.5f, 0f, 0f, 3f),
    CHICKEN(MEAT, 0.6f, 2f, 0f, 0.5f, 2.5f, 0f, 0f, 3f),
    COD(MEAT, 0.6f, 2f, 0f, 0f, 2f, 0f, 0f, 4f),
    HORSE_MEAT(MEAT, 0.8f, 2f, 0f, 1f, 2.5f, 0f, 0f, 3f),
    MUTTON(MEAT, 0.8f, 2f, 0f, 1.5f, 2.5f, 0f, 0f, 3f),
    PHEASANT(MEAT, 0.8f, 2f, 0f, 2f, 2.5f, 0f, 0f, 3f),
    PORK(MEAT, 0.8f, 2f, 0f, 2f, 2.5f, 0f, 0f, 3f),
    REEF_FISH(MEAT, 0.6f, 2f, 0f, 0f, 2f, 0f, 0f, 4f),
    SALMON(MEAT, 0.6f, 2f, 0f, 1f, 2f, 0.5f, 0f, 4f),
    TROUT(MEAT, 0.6f, 2f, 0f, 1f, 2f, 0f, 0f, 4f),
    VENISON(MEAT, 0.6f, 2f, 0f, 0.5f, 2f, 0f, 0f, 3f),
    CHEESE(DAIRY, 0.8f, 3f, 0f, 2.5f, 2f, 0f, 2f, 2f),
    COOKED_EGG(DAIRY, 0.6f, 0f, 2f, 2f, 1.5f, 0f, 1f, 1f),
    MILK(DAIRY, 0.2f, 10f, 0f, 0f, 0f, 0f, 2f, 3f),
    SUGAR(GRAIN, 0.2f, 3f, 0f, 0f, 0f, 0f, 0f, 1f),
