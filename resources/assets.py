...
def generate(rm: ResourceManager):
    ...
    rm.block(('wood', 'planks', 'palm_mosaic_stairs')).with_lang(lang('palm mosaic stairs')).with_block_loot('tfc:wood/planks/palm_mosaic_stairs').with_tag('minecraft:wooden_slabs')
