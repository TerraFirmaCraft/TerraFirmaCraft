...
def match_tag_1_21_plus(tag: str) -> Json:
    tag = "#" + tag
    return {
...
def generate(rm: ResourceManager):
    ...
    rm.blockstate('thermometer', variants={
        'power=0,facing=north': {'model': 'tfc:block/thermometer/thermometer_0'},
        'power=1,facing=north': {'model': 'tfc:block/thermometer/thermometer_0'},
        'power=2,facing=north': {'model': 'tfc:block/thermometer/thermometer_1'},
        'power=3,facing=north': {'model': 'tfc:block/thermometer/thermometer_2'},
        'power=4,facing=north': {'model': 'tfc:block/thermometer/thermometer_2'},
        'power=5,facing=north': {'model': 'tfc:block/thermometer/thermometer_3'},
        'power=6,facing=north': {'model': 'tfc:block/thermometer/thermometer_4'},
        'power=7,facing=north': {'model': 'tfc:block/thermometer/thermometer_4'},
        'power=8,facing=north': {'model': 'tfc:block/thermometer/thermometer_5'},
        'power=9,facing=north': {'model': 'tfc:block/thermometer/thermometer_6'},
        'power=10,facing=north': {'model': 'tfc:block/thermometer/thermometer_6'},
        'power=11,facing=north': {'model': 'tfc:block/thermometer/thermometer_7'},
        'power=12,facing=north': {'model': 'tfc:block/thermometer/thermometer_8'},
        'power=13,facing=north': {'model': 'tfc:block/thermometer/thermometer_8'},
        'power=14,facing=north': {'model': 'tfc:block/thermometer/thermometer_9'},
        'power=15,facing=north': {'model': 'tfc:block/thermometer/thermometer_10'},
        'power=0,facing=south': {'model': 'tfc:block/thermometer/thermometer_0', 'y': 180},
        'power=1,facing=south': {'model': 'tfc:block/thermometer/thermometer_0', 'y': 180},
        'power=2,facing=south': {'model': 'tfc:block/thermometer/thermometer_1', 'y': 180},
        'power=3,facing=south': {'model': 'tfc:block/thermometer/thermometer_2', 'y': 180},
        'power=4,facing=south': {'model': 'tfc:block/thermometer/thermometer_2', 'y': 180},
        'power=5,facing=south': {'model': 'tfc:block/thermometer/thermometer_3', 'y': 180},
        'power=6,facing=south': {'model': 'tfc:block/thermometer/thermometer_4', 'y': 180},
        'power=7,facing=south': {'model': 'tfc:block/thermometer/thermometer_4', 'y': 180},
        'power=8,facing=south': {'model': 'tfc:block/thermometer/thermometer_5', 'y': 180},
        'power=9,facing=south': {'model': 'tfc:block/thermometer/thermometer_6', 'y': 180},
        'power=10,facing=south': {'model': 'tfc:block/thermometer/thermometer_6', 'y': 180},
        'power=11,facing=south': {'model': 'tfc:block/thermometer/thermometer_7', 'y': 180},
        'power=12,facing=south': {'model': 'tfc:block/thermometer/thermometer_8', 'y': 180},
        'power=13,facing=south': {'model': 'tfc:block/thermometer/thermometer_8', 'y': 180},
        'power=14,facing=south': {'model': 'tfc:block/thermometer/thermometer_9', 'y': 180},
        'power=15,facing=south': {'model': 'tfc:block/thermometer/thermometer_10', 'y': 180},
        'power=0,facing=east': {'model': 'tfc:block/thermometer/thermometer_0', 'y': 90},
        'power=1,facing=east': {'model': 'tfc:block/thermometer/thermometer_0', 'y': 90},
        'power=2,facing=east': {'model': 'tfc:block/thermometer/thermometer_1', 'y': 90},
        'power=3,facing=east': {'model': 'tfc:block/thermometer/thermometer_2', 'y': 90},
        'power=4,facing=east': {'model': 'tfc:block/thermometer/thermometer_2', 'y': 90},
        'power=5,facing=east': {'model': 'tfc:block/thermometer/thermometer_3', 'y': 90},
        'power=6,facing=east': {'model': 'tfc:block/thermometer/thermometer_4', 'y': 90},
        'power=7,facing=east': {'model': 'tfc:block/thermometer/thermometer_4', 'y': 90},
        'power=8,facing=east': {'model': 'tfc:block/thermometer/thermometer_5', 'y': 90},
        'power=9,facing=east': {'model': 'tfc:block/thermometer/thermometer_6', 'y': 90},
        'power=10,facing=east': {'model': 'tfc:block/thermometer/thermometer_6', 'y': 90},
        'power=11,facing=east': {'model': 'tfc:block/thermometer/thermometer_7', 'y': 90},
        'power=12,facing=east': {'model': 'tfc:block/thermometer/thermometer_8', 'y': 90},
        'power=13,facing=east': {'model': 'tfc:block/thermometer/thermometer_8', 'y': 90},
        'power=14,facing=east': {'model': 'tfc:block/thermometer/thermometer_9', 'y': 90},
        'power=15,facing=east': {'model': 'tfc:block/thermometer/thermometer_10', 'y': 90},
        'power=0,facing=west': {'model': 'tfc:block/thermometer/thermometer_0', 'y': 270},
        'power=1,facing=west': {'model': 'tfc:block/thermometer/thermometer_0', 'y': 270},
        'power=2,facing=west': {'model': 'tfc:block/thermometer/thermometer_1', 'y': 270},
        'power=3,facing=west': {'model': 'tfc:block/thermometer/thermometer_2', 'y': 270},
        'power=4,facing=west': {'model': 'tfc:block/thermometer/thermometer_2', 'y': 270},
        'power=5,facing=west': {'model': 'tfc:block/thermometer/thermometer_3', 'y': 270},
        'power=6,facing=west': {'model': 'tfc:block/thermometer/thermometer_4', 'y': 270},
        'power=7,facing=west': {'model': 'tfc:block/thermometer/thermometer_4', 'y': 270},
        'power=8,facing=west': {'model': 'tfc:block/thermometer/thermometer_5', 'y': 270},
        'power=9,facing=west': {'model': 'tfc:block/thermometer/thermometer_6', 'y': 270},
        'power=10,facing=west': {'model': 'tfc:block/thermometer/thermometer_6', 'y': 270},
        'power=11,facing=west': {'model': 'tfc:block/thermometer/thermometer_7', 'y': 270},
        'power=12,facing=west': {'model': 'tfc:block/thermometer/thermometer_8', 'y': 270},
        'power=13,facing=west': {'model': 'tfc:block/thermometer/thermometer_8', 'y': 270},
        'power=14,facing=west': {'model': 'tfc:block/thermometer/thermometer_9', 'y': 270},
        'power=15,facing=west': {'model': 'tfc:block/thermometer/thermometer_10', 'y': 270},
    }).with_lang(lang('Thermometer')).with_block_loot('tfc:thermometer')
    ...
    for plant, plant_data in PLANTS.items():
        ...
        if plant_data.type == 'short_grass' or plant_data.type == 'beach_grass':
            rm.block_loot(p, ({
                'name': p,
                'conditions': [match_tag_1_21_plus(TAG_SHEARS)],
            }, {
                'name': 'tfc:straw',
            ...
            rm.block_loot(p, (
                ...
                {'name': p, 'conditions': [match_tag_1_21_plus(TAG_SHEARS)]}
            ))
        elif plant_data.type in ('tall_plant', 'emergent', 'emergent_fresh', 'cactus'):
            if plant == 'cattail':
                rm.block_loot(p, (
                    {'name': 'tfc:food/cattail_root', 'conditions': [match_tag_1_21_plus(TAG_SHARP), loot_tables.random_chance(0.3), lower_only]},
                    {'name': p, 'conditions': [match_tag_1_21_plus(TAG_SHEARS), lower_only]}
                ))
            elif plant == 'water_taro':
                rm.block_loot(p, (
                    {'name': 'tfc:food/taro_root', 'conditions': [match_tag_1_21_plus(TAG_SHARP), loot_tables.random_chance(0.3), lower_only]},
                    {'name': p, 'conditions': [match_tag_1_21_plus(TAG_SHEARS), lower_only]}
                ))
            else:
    ...
    for fruit in JAR_FRUITS:
            ...
            substance_name = 'jam'
            if fruit == 'peanut':
                substance_name = 'butter'
            rm.item_model('tfc:jar/%s' % fruit, 'tfc:item/jar/%s' % fruit).with_lang(lang('jar of %s %s', fixed_name, substance_name))
            rm.item_model('tfc:jar/%s_unsealed' % fruit, 'tfc:item/jar/%s_unsealed' % fruit).with_lang(lang('jar of %s %s', fixed_name, substance_name))
            rm.item_model('%s_jam' % fruit, 'tfc:item/food/%s_jam' % fruit).with_lang(lang('%s %s', fixed_name, substance_name))
    ...
    for berry, data in BERRIES.items():
        ...
        if data.type == 'stationary' or data.type == 'waterlogged':
            ...
            rm.block_loot('plant/%s_bush' % berry, {'name': 'tfc:plant/%s_bush' % berry, 'conditions': [match_tag_1_21_plus(TAG_SHARP)]})
            ...
            rm.block_loot('plant/%s_bush' % berry, (
                {'name': 'tfc:plant/%s_bush' % berry, 'conditions': [match_tag_1_21_plus(TAG_SHARP), loot_tables.block_state_property('tfc:plant/%s_bush[stage=2]' % berry)]},
                {'name': 'tfc:plant/%s_bush' % berry, 'conditions': [match_tag_1_21_plus(TAG_SHARP), loot_tables.random_chance(0.5)]}
            ), 'minecraft:stick')
