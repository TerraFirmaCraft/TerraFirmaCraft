...
def generate(rm: ResourceManager):
    ...
    mob_loot(rm, 'grouse', 'tfc:food/pheasant', 2, 3, 'large', bones=2)
    mob_loot(rm, 'pheasant', 'tfc:food/pheasant', 2, 3, 'large', bones=2)
    mob_loot(rm, 'turkey', 'tfc:food/pheasant', 2, 4, 'large', bones=2)
