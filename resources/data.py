...
def generate(rm: ResourceManager):
    ...
    mob_loot(rm, 'goat', 'tfc:food/chevon', 1, 4, 'medium', bones=4)
    mob_loot(rm, 'yak', 'tfc:food/chevon', 1, 4, 'large', bones=4)
    mob_loot(rm, 'alpaca', 'tfc:food/camelidae', 1, 4, 'medium', bones=4, extra_pool={'name': 'tfc:wool'})
    mob_loot(rm, 'sheep', 'tfc:food/mutton', 1, 4, 'medium', bones=4, extra_pool={'name': 'tfc:wool'})
    mob_loot(rm, 'musk_ox', 'tfc:food/mutton', 1, 4, 'large', bones=4, extra_pool={'name': 'tfc:wool'})
    mob_loot(rm, 'chicken', 'tfc:food/chicken', extra_pool={'name': 'minecraft:feather', 'functions': [loot_tables.set_count(1, 4)]})
    mob_loot(rm, 'duck', 'tfc:food/duck', extra_pool={'name': 'minecraft:feather', 'functions': [loot_tables.set_count(1, 4)]})
    mob_loot(rm, 'quail', 'tfc:food/quail', extra_pool={'name': 'minecraft:feather', 'functions': [loot_tables.set_count(1, 4)]})
