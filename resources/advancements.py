...
def generate(rm: ResourceManager):
    ...
    world.advancement('globe_trotter', icon('minecraft:map'), 'Globe Trotter', 'Travel to positive 20,000 and -20,000 z, the hottest and coldest points nearest to spawn', 'root', multiple(location({'position': {'z': {'min': 20000}}}, name='high'), location({'position': {'z': {'max': -20000}}}, name='low')), requirements=[['high'], ['low']], frame='challenge')
