...
def main():
    ...
    make('foliage_evergreen.png', (0, 0, '#1D6233'), (255, 0, '57776D'), (0, 255, '#8EA825'), (255, 255, '#9C8733'))
    make('foliage_summer.png',
         (0, 30, '#5cc445'), (90, 30, '#1f6937'), (215, 30, '#1c592f'), (255, 30, '#68823E'),
         (0, 210, '#5cc445'), (80, 210, '#6d9421'), (215, 210, '#70851d'), (255, 210, '#68823E'),
         (0, 255, '#5cc445'), (80, 255, '#72801c'), (215, 255, '#7d7c1c'), (255, 255, '#68823E'))
