...
def generate(rm: ResourceManager):
    ...
    rm.item_tag('fluid_item_ingredient_empty_containers', 'minecraft:bucket', 'tfc:wooden_bucket', '#tfc:fired_jugs', 'tfc:metal/bucket/red_steel', 'tfc:metal/bucket/blue_steel', '#tfc:glass_bottles')
    ...
    rm.item_tag('unfired_jugs', 'tfc:ceramic/unfired_jug', *['tfc:ceramic/%s_unfired_jug' % c for c in COLORS])
    ...
    rm.item_tag('fired_jugs', 'tfc:ceramic/jug', *['tfc:ceramic/%s_glazed_jug' % c for c in COLORS])
    ...
    rm.item_tag('jugs', '#tfc:unfired_jugs', '#tfc:fired_jugs')
