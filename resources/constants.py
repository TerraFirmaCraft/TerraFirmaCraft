...
ORE_VEINS: Dict[str, Vein] = {
    ...
    'surface_cassiterite': Vein('cassiterite', 'cluster', 40, 15, 60, 160, 60, 60, 30, 10, ['igneous_intrusive']),
...
PLANTS: Dict[str, Plant] = {
    'allium': Plant(False, -40, 33, 150, 400, 'standard'),
    'athyrium_fern': Plant(True, 20, 30, 200, 500, 'standard'),
    'barrel_cactus': Plant(False, -6, 50, 0, 75, 'cactus'),
    'black_orchid': Plant(False, 30, 50, 300, 410, 'standard'),
    'blood_lily': Plant(False, 33, 45, 200, 500, 'standard'),
    'blue_orchid': Plant(False, 8, 40, 300, 500, 'standard'),
    'butterfly_milkweed': Plant(False, -40, 25, 75, 300, 'standard'),
    'calendula': Plant(False, -46, 26, 130, 300, 'standard'),
    'canna': Plant(True, 30, 50, 280, 500, 'standard'),
    'cattail': Plant(False, -10, 50, 150, 500, 'emergent'),
    'dandelion': Plant(False, -40, 20, 75, 400, 'standard'),
    ...
    'ostrich_fern': Plant(False, -40, 33, 300, 500, 'tall_plant'),
    'oxeye_daisy': Plant(False, -40, 33, 120, 300, 'standard'),
    'pampas_grass': Plant(True, 25, 50, 75, 200, 'tall_grass'),
    ...
    'sacred_datura': Plant(False, 5, 33, 75, 150, 'standard'),
    'sago': Plant(False, -10, 50, 200, 500, 'water'),
    'sagebrush': Plant(False, -34, 50, 0, 100, 'dry'),
    'sapphire_tower': Plant(False, -6, 38, 75, 200, 'tall_plant'),
    'sargassum': Plant(False, 0, 38, 0, 500, 'floating_sea'),
    ...
    'timothy_grass': Plant(False, -5, 31, 300, 500, 'short_grass'),
    'toquilla_palm': Plant(False, 25, 50, 250, 500, 'tall_plant'),
    'tree_fern': Plant(False, 10, 50, 300, 500, 'tall_plant'),
    'trillium': Plant(False, -34, 33, 150, 300, 'standard'),
    'tropical_milkweed': Plant(False, -6, 36, 120, 300, 'standard'),
    'tulip_orange': Plant(False, -34, 15, 100, 200, 'standard'),
    'tulip_pink': Plant(False, -34, 15, 100, 200, 'standard'),
    'tulip_red': Plant(False, -34, 15, 100, 200, 'standard'),
    'tulip_white': Plant(False, -34, 15, 100, 200, 'standard'),
    'vriesea': Plant(False, 15, 50, 300, 500, 'epiphyte'),
    'water_canna': Plant(True, -12, 36, 150, 500, 'floating'),
    'water_lily': Plant(False, 10, 38, 0, 500, 'floating'),
