...
DEFAULT_LANG = {
    ...
    **dict(('subtitles.item.armor.equip_%s' % metal, '%s armor equips' % lang(metal)) for metal, data in METALS.items() if 'armor' in data.types),
    ...
    'tfc.creative_mode_tab.ores': 'TFC Ores',
    'tfc.creative_mode_tab.rock': 'TFC Rock Stuffs',
    'tfc.creative_mode_tab.metals': 'TFC Metal Stuffs',
    'tfc.creative_mode_tab.wood': 'TFC Wooden Stuffs',
    'tfc.creative_mode_tab.flora': 'TFC Flora',
    'tfc.creative_mode_tab.devices': 'TFC Devices',
    'tfc.creative_mode_tab.food': 'TFC Food',
    'tfc.creative_mode_tab.misc': 'TFC Misc',
    'tfc.creative_mode_tab.decorations': 'TFC Decorations',
    # Containers
    ...
    **dict(('tfc.enum.platetectonicsclassification.%s' % k, v) for k, v in {
    ...
    'tfc.enum.variant.brown': 'Brown Fur',
    'tfc.enum.variant.white': 'White Fur',
    'tfc.enum.variant.black': 'Black Fur',
    'tfc.enum.variant.white_splotched': 'White Splotched Fur',
    'tfc.enum.variant.gold': 'Golden Fur',
    'tfc.enum.variant.salty': 'Salty Fur',
    'tfc.enum.variant.evil': '§cEvil',
