...
PLANTS: Dict[str, Plant] = {
    ...
    'pulsatilla': Plant(False, -10, 10, 50, 200, 'standard'),
    ...
    'snapdragon_pink': Plant(False, 2, 12, 150, 300, 'standard'),
    'snapdragon_red': Plant(False, 2, 12, 150, 300, 'standard'),
    'snapdragon_white': Plant(False, 2, 12, 150, 300, 'standard'),
    'snapdragon_yellow': Plant(False, 2, 12, 150, 300, 'standard'),
    ...
    'tulip_orange': Plant(False, -12, 10, 200, 400, 'standard'),
    'tulip_pink': Plant(False, -12, 10, 200, 400, 'standard'),
    'tulip_red': Plant(False, -12, 10, 200, 400, 'standard'),
    'tulip_white': Plant(False, -12, 10, 200, 400, 'standard'),
    ...
    'water_canna': Plant(True, 4, 40, 150, 500, 'floating_fresh'),
    'athyrium_fern': Plant(True, -10, 10, 200, 500, 'standard'),
    'canna': Plant(True, 4, 40, 270, 500, 'standard'),
    'goldenrod': Plant(True, -16, 10, 75, 310, 'standard'),
    'pampas_grass': Plant(True, 8, 40, 0, 200, 'tall_grass'),
    'perovskia': Plant(True, -6, 14, 0, 200, 'dry'),
    ...
    'morning_glory': Plant(False, -6, 18, 300, 500, 'creeping'),
    'moss': Plant(False, -10, 40, 250, 450, 'creeping'),
    'reindeer_lichen': Plant(False, -24, -8, -50, 33, 'creeping')
