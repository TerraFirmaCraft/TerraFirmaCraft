...
Plant = namedtuple('Plant', ('clay', 'min_temp', 'max_temp', 'min_rain', 'max_rain'))
...
PLANTS: Dict[str, Plant] = {
    'allium': Plant(False, -40, 33, 150, 500),
    'athyrium_fern': Plant(True, -35, 31, 200, 500),
    'barrel_cactus': Plant(False, -6, 50, 0, 75),
    'black_orchid': Plant(False, 10, 50, 300, 500),
    'blood_lily': Plant(False, 10, 50, 200, 500),
    'blue_orchid': Plant(False, 10, 50, 300, 500),
    'butterfly_milkweed': Plant(False, -40, 32, 75, 300),
    'calendula': Plant(False, -46, 30, 130, 300),
    'canna': Plant(True, -12, 36, 150, 500),
    'dandelion': Plant(False, -40, 40, 75, 400),
    'duckweed': Plant(False, -34, 38, 0, 500),
    'field_horsetail': Plant(False, -40, 33, 300, 500),
    'fountain_grass': Plant(False, -12, 40, 75, 150),
    'foxglove': Plant(False, -34, 34, 150, 300),
    'goldenrod': Plant(True, -29, 32, 75, 300),
    'grape_hyacinth': Plant(False, -34, 32, 150, 250),
    'guzmania': Plant(False, 15, 50, 300, 500),
    'houstonia': Plant(False, -46, 36, 150, 500),
    'labrador_tea': Plant(False, -50, 33, 300, 500),
    'lady_fern': Plant(False, -34, 32, 200, 500),
    'licorice_fern': Plant(False, -29, 25, 300, 500),
    'lotus': Plant(False, 10, 50, 0, 500),
    'meads_milkweed': Plant(False, -23, 31, 130, 500),
    'morning_glory': Plant(False, -40, 31, 150, 500),
    'moss': Plant(False, -7, 36, 250, 500),
    'nasturtium': Plant(False, -46, 38, 150, 500),
    'orchard_grass': Plant(False, -29, 30, 75, 300),
    'ostrich_fern': Plant(False, -40, 33, 300, 500),
    'oxeye_daisy': Plant(False, -40, 33, 120, 300),
    'pampas_grass': Plant(True, -12, 36, 75, 200),
    'perovskia': Plant(True, -29, 32, 0, 200),
    'pistia': Plant(False, 10, 50, 0, 500),
    'poppy': Plant(False, -40, 36, 150, 250),
    'primrose': Plant(False, -34, 33, 150, 300),
    'pulsatilla': Plant(False, -50, 30, 50, 200),
    'reindeer_lichen': Plant(False, -50, 33, 50, 500),
    'rose': Plant(True, -29, 34, 150, 300),
    'ryegrass': Plant(False, -46, 32, 150, 300),
    'sacred_datura': Plant(False, 5, 33, 75, 150),
    'sagebrush': Plant(False, -34, 50, 0, 100),
    'sapphire_tower': Plant(False, -6, 38, 75, 200),
    'sargassum': Plant(False, 0, 38, 0, 500),
    'scutch_grass': Plant(False, -17, 50, 150, 500),
    'snapdragon_pink': Plant(False, -28, 36, 150, 300),
    'snapdragon_red': Plant(False, -28, 36, 150, 300),
    'snapdragon_white': Plant(False, -28, 36, 150, 300),
    'snapdragon_yellow': Plant(False, -28, 36, 150, 300),
    'spanish_moss': Plant(False, 0, 40, 300, 500),
    'strelitzia': Plant(False, 5, 50, 50, 300),
    'switchgrass': Plant(False, -29, 32, 100, 300),
    'sword_fern': Plant(False, -40, 30, 100, 500),
    'tall_fescue_grass': Plant(False, -29, 30, 300, 500),
    'timothy_grass': Plant(False, -46, 30, 300, 500),
    'toquilla_palm': Plant(False, 10, 50, 250, 500),
    'tree_fern': Plant(False, 10, 50, 300, 500),
    'trillium': Plant(False, -34, 33, 150, 300),
    'tropical_milkweed': Plant(False, -6, 36, 120, 300),
    'tulip_orange': Plant(False, -34, 33, 100, 200),
    'tulip_pink': Plant(False, -34, 33, 100, 200),
    'tulip_red': Plant(False, -34, 33, 100, 200),
    'tulip_white': Plant(False, -34, 33, 100, 200),
    'vriesea': Plant(False, 15, 50, 300, 500),
    'water_canna': Plant(True, -12, 36, 150, 500),
    'water_lily': Plant(False, -34, 38, 0, 500),
    'yucca': Plant(False, -34, 36, 0, 75)
}
