...
METAL_BLOCKS: dict[str, MetalItem] = {
    ...
    'exposed_block': MetalItem('part', 100, 'block/block', None, False, False),
    'weathered_block': MetalItem('part', 100, 'block/block', None, False, False),
    'oxidized_block': MetalItem('part', 100, 'block/block', None, False, False),
    'block_slab': MetalItem('part', 50, 'block/block', None, False, False),
    'exposed_block_slab': MetalItem('part', 50, 'block/block', None, False, False),
    'weathered_block_slab': MetalItem('part', 50, 'block/block', None, False, False),
    'oxidized_block_slab': MetalItem('part', 50, 'block/block', None, False, False),
    'block_stairs': MetalItem('part', 75, 'block/block', None, False, False),
    'exposed_block_stairs': MetalItem('part', 75, 'block/block', None, False, False),
    'weathered_block_stairs': MetalItem('part', 75, 'block/block', None, False, False),
    'oxidized_block_stairs': MetalItem('part', 75, 'block/block', None, False, False),
