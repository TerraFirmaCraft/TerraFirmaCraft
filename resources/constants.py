...
DEFAULT_LANG = {
    ...
    **dict(('subtitles.entity.tfc.%s.hurt' % fish, '%s hurts' % fish.title().replace('_', ' ')) for fish in (*SIMPLE_FRESHWATER_FISH, 'manatee', 'jellyfish')),
    ...
    'tfc.tooltip.climate_peak_rainfall_summer': 'Peak Rainfall: %smm/yr in Summer',
    ...
    **lang_enum('direction', ('north', 'south', 'east', 'west', 'down', 'up')),
    "tfc.enum.koppenclimateclassification.af": "Tropical Rainforest (Af)",
    "tfc.enum.koppenclimateclassification.am": "Tropical Monsoon (Am)",
    "tfc.enum.koppenclimateclassification.aw": "Tropical Savanna (Aw)",
    "tfc.enum.koppenclimateclassification.as": "Tropical Savanna (As)",
    "tfc.enum.koppenclimateclassification.bwh": "Hot Desert (BWh)",
    "tfc.enum.koppenclimateclassification.bwk": "Cold Desert (BWk)",
    "tfc.enum.koppenclimateclassification.bsh": "Hot Semi-Arid (BSh)",
    "tfc.enum.koppenclimateclassification.bsk": "Cold Semi-Arid (BSk)",
    "tfc.enum.koppenclimateclassification.csa": "Mediterranean (Csa)",
    "tfc.enum.koppenclimateclassification.csb": "Mediterranean (Csb)",
    "tfc.enum.koppenclimateclassification.csc": "Mediterranean (Csc)",
    "tfc.enum.koppenclimateclassification.cwa": "Subtropical (Cwa)",
    "tfc.enum.koppenclimateclassification.cwb": "Temperate (Cwb)",
    "tfc.enum.koppenclimateclassification.cwc": "Temperate (Cwc)",
    "tfc.enum.koppenclimateclassification.cfa": "Humid Subtropical (Cfa)",
    "tfc.enum.koppenclimateclassification.cfb": "Oceanic (Cfb)",
    "tfc.enum.koppenclimateclassification.cfc": "Oceanic (Cfc)",
    "tfc.enum.koppenclimateclassification.dsa": "Continental (Dsa)",
    "tfc.enum.koppenclimateclassification.dsb": "Continental (Dsb)",
    "tfc.enum.koppenclimateclassification.dsc": "Subarctic (Dsc)",
    "tfc.enum.koppenclimateclassification.dsd": "Subarctic (Dsd)",
    "tfc.enum.koppenclimateclassification.dwa": "Continental (Dwa)",
    "tfc.enum.koppenclimateclassification.dwb": "Continental (Dwb)",
    "tfc.enum.koppenclimateclassification.dwc": "Subarctic (Dwc)",
    "tfc.enum.koppenclimateclassification.dwd": "Subarctic (Dwd)",
    "tfc.enum.koppenclimateclassification.dfa": "Continental (Dfa)",
    "tfc.enum.koppenclimateclassification.dfb": "Continental (Dfb)",
    "tfc.enum.koppenclimateclassification.dfc": "Subarctic (Dfc)",
    "tfc.enum.koppenclimateclassification.dfd": "Subarctic (Dfd)",
    "tfc.enum.koppenclimateclassification.et": "Tundra (ET)",
    "tfc.enum.koppenclimateclassification.ef": "Ice Cap (EF)",
