...
DEFAULT_LANG = {
    ...
    **dict(('subtitles.item.armor.equip_%s' % metal, '%s armor equips' % metal.capitalize().replace('_', ' ')) for metal, data in METALS.items() if 'armor' in data.types),
    ...
    'tfc.jade.animal_wear': 'Wear & Tear: ',
    'tfc.jade.familiarity': 'Familiarity: ',
    ...
    'tfc.jade.gestation_progress': 'Gestation Progress: ',
    'tfc.jade.may_ride_horse': 'May be ridden',
    'tfc.jade.explosion_strength': 'Explosion Strength: ',
    'tfc.jade.max_health': 'Max Health: ',
    'tfc.jade.yield': 'Yield Multiplier: ',
    'tfc.jade.no_stick': 'Needs stick to reach max growth',
    'tfc.jade.bellows_start': 'W',
    'tfc.jade.bellows_middle': 'o',
    'tfc.jade.bellows_end': 'sh',
