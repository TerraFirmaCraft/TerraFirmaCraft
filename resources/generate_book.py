...
def make_book(rm: ResourceManager, i18n: I18n, local_instance: bool = False):
    ...
    book.category('mechanics', 'Advanced Mechanics', 'Advanced sections of the tech tree, from the first pickaxe, all the way to colored steel.', 'tfc:metal/axe/red_steel', entries=(
        ...
        entry('steel', 'Steel', 'tfc:metal/ingot/steel', pages=(
            ...
            welding_recipe('tfc:welding/high_carbon_black_steel_ingot', '$(thing)Weak Steel Ingots$() can then be welded with $(thing)Pig Iron Ingots$() to create $(thing)High Carbon Black Steel Ingots$(). Finally, these can then be worked on an $(l:mechanics/anvil)Anvil$() to create $(thing)Black Steel Ingots$().'),
            ...
            welding_recipe('tfc:welding/high_carbon_blue_steel', '$(thing)Weak Blue Steel Ingots$() can then be welded with $(l:mechanics/steel#black_steel)Black Steel Ingots$() to create $(thing)High Carbon Blue Steel Ingots$(). Finally, these can then be worked on an $(l:mechanics/anvil)Anvil$() to create $(thing)Blue Steel Ingots$().'),
            ...
            welding_recipe('tfc:welding/high_carbon_red_steel', '$(thing)Weak Red Steel Ingots$() can then be welded with $(l:mechanics/steel#black_steel)Black Steel Ingots$() to create $(thing)High Carbon Red Steel Ingots$(). Finally, these can then be worked on an $(l:mechanics/anvil)Anvil$() to create $(thing)Red Steel Ingots$().'),
