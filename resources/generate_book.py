...
def make_book(rm: ResourceManager, i18n: I18n, local_instance: bool = False, reverse_translate: bool = False):
    ...
    book.category('getting_started', 'Getting Started', 'An introduction to surviving in the world of TerraFirmaCraft. How to survive the stone age and obtain your first pickaxe.', 'tfc:stone/axe/sedimentary', is_sorted=True, entries=(
        ...
        entry('pottery', 'Pottery', 'tfc:ceramic/vessel', pages=(
            ...
            text('The small vessel is one such item. Like all pottery items, it must be $(l:https://en.wikipedia.org/wiki/Pottery)fired$() before it can be used. Firing is a process of $(l:core_mechanics/heating)heating$() the item up to a point where the clay will turn into a hard $(thing)Ceramic$() material, which requires heating to 1400 °C, or $(#FFDF00)$(bold)$(t:Yellow White)Yellow White$().$(br2)In order to do this in the early game, you will need to use a $(l:getting_started/pit_kiln)Pit Kiln$().', title='Small Vessel').link('tfc:ceramic/unfired_vessel').link('tfc:ceramic/vessel').anchor('vessel'),
        ...
        entry('pit_kiln', 'Pit Kilns', 'tfc:textures/gui/book/icons/pit_kiln.png', pages=(
            text('A pit kiln is an early game method of $(l:core_mechanics/heating)heating$() items up. It can be used to $(thing)fire$() clay into ceramic, for example. The pit kiln, over the time period of about six hours, will heat its contents up to 1400 °C, or $(bold)$(#FFDF00)$(t:Yellow White)Yellow White$().'),
    ...
    book.category('the_world', 'The World', 'All about the natural world around you.', 'tfc:grass/entisol', is_sorted=True, entries=(
        ...
        entry('wild_animals', 'Wild Animals', 'tfc:medium_raw_hide', pages=(
            ...
            entity('tfc:polar_bear', 'The polar bear spawns in only the coldest regions, $(l:core_mechanics/climate#temperature)temperature$() at most 10°C, with a $(l:core_mechanics/climate#rainfall)rainfall$() of at least 100mm.', 'Polar Bear', 0.55),
            entity('tfc:grizzly_bear', 'The grizzly bear spawns in forests of moderate climates, with a $(l:core_mechanics/climate#temperature)temperature$() range of -15 to 15°C and at least 200mm of $(l:core_mechanics/climate#rainfall)rainfall$().', 'Grizzly Bear', 0.55),
            entity('tfc:black_bear', 'The black bear spawns in forests of warmer, wetter climates, of $(l:core_mechanics/climate#temperature)temperature$() 5 to 20°C and at least 250mm of $(l:core_mechanics/climate#rainfall)rainfall$().', 'Black Bear', 0.55),
            entity('tfc:cougar', 'The cougar prefers most moderate climates, with $(l:core_mechanics/climate#temperature)temperature$() from -10 to 21°C and at least 150mm of $(l:core_mechanics/climate#rainfall)rainfall$().', 'Cougar', 0.6),
            entity('tfc:panther', 'The panther prefers most moderate climates, with $(l:core_mechanics/climate#temperature)temperature$() from -10 to 21°C and at least 150mm of $(l:core_mechanics/climate#rainfall)rainfall$().', 'Panther', 0.6),
            entity('tfc:lion', 'The lion spawns in plains with an average $(l:core_mechanics/climate#temperature)temperature$() of at least 16°C, and $(l:core_mechanics/climate#rainfall)rainfall$() between 50 and 300mm.', 'Lion', 0.55),
            entity('tfc:tiger', 'The tiger spawns in forests with an average $(l:core_mechanics/climate#temperature)temperature$() of at least 13°C, and $(l:core_mechanics/climate#rainfall)rainfall$() above 100mm.', 'Tiger', 0.55),
            entity('tfc:sabertooth', 'The sabertooth spawns at any $(l:core_mechanics/climate#temperature)temperature$() above 0°C, and any $(l:core_mechanics/climate#rainfall)rainfall$() above 250mm.', 'Sabertooth', 0.6),
            entity('tfc:wolf', 'The wolf spawns at any $(l:core_mechanics/climate#temperature)temperature$() below 22°C, and $(l:core_mechanics/climate#rainfall)rainfall$() between 150 and 420mm. They hunt in packs. Feeding a wolf enough times will tame it into a $(l:food/pets)Dog$().'),
            ...
            entity('tfc:hyena', 'The hyena spawns at any $(l:core_mechanics/climate#temperature)temperature$() warmer than 15°C, and $(l:core_mechanics/climate#rainfall)rainfall$() between 80 and 380mm. They hunt in packs. They are not tamable.'),
            entity('tfc:crocodile', 'The crocodile spawns near rivers, lakes, and marshes at any $(l:core_mechanics/climate#temperature)temperature$() warmer than 15°C, and at any $(l:core_mechanics/climate#rainfall)rainfall$(). They are nocturnal, and most dangerous in the water.', 'Crocodile', 0.7),
            entity('tfc:ocelot', 'The ocelot attacks small animals. It spawns at any $(l:core_mechanics/climate#temperature)temperature$() from 15 to 30°C, and $(l:core_mechanics/climate#rainfall)rainfall$() between 300 and 500mm, in forests. Feeding an ocelot enough times will tame it into a $(l:food/pets)Cat$(). Ocelots can eat raw fish'),
            page_break(),
            ...
            entity('tfc:boar', 'The boar spawns at $(l:core_mechanics/climate#temperature)temperature$() below 25°C and above -5°C, and $(l:core_mechanics/climate#rainfall)rainfall$() between 130 and 400mm.', 'Boar', 0.8),
            entity('tfc:moose', 'The moose spawns in forests at $(l:core_mechanics/climate#temperature)temperature$() below 10°C and above -15°C, and $(l:core_mechanics/climate#rainfall)rainfall$() between 150 and 300mm.'),
            entity('tfc:wildebeest', 'The wildebeest spawns in open plains at any $(l:core_mechanics/climate#temperature)temperature$() above 13°C, and $(l:core_mechanics/climate#rainfall)rainfall$() between 90 and 380mm.'),
            entity('tfc:bison', 'The bison spawns in open plains at any $(l:core_mechanics/climate#temperature)temperature$() above -10°C and below 15°C, and $(l:core_mechanics/climate#rainfall)rainfall$() between 160 and 420mm.', 'Bison', 0.6),
            empty(),
            page_break(),
            ...
            entity('tfc:fox', 'The fox likes to eat the berries off of bushes. It can be found in forests with $(l:core_mechanics/climate#temperature)temperature$() below 25°C, and $(l:core_mechanics/climate#rainfall)rainfall$() between 130 and 400mm.', 'Fox'),
            entity('tfc:deer', 'The deer spawns in forests at any $(l:core_mechanics/climate#temperature)temperature$() below 25°C and above -15°C, and $(l:core_mechanics/climate#rainfall)rainfall$() between 130 and 400mm.'),
            entity('tfc:caribou', 'The caribou spawns at any $(l:core_mechanics/climate#temperature)temperature$() below -9°C, and $(l:core_mechanics/climate#rainfall)rainfall$() between 110 and 500mm.', 'Caribou', 0.5),
            entity('tfc:gazelle', 'The gazelle spawns in open plains at any $(l:core_mechanics/climate#temperature)temperature$() above 12°C, and $(l:core_mechanics/climate#rainfall)rainfall$() between 90 and 380mm.'),
            entity('tfc:bongo', 'The bongo spawns in forests at any $(l:core_mechanics/climate#temperature)temperature$() above 15°C, and $(l:core_mechanics/climate#rainfall)rainfall$() between 230 and 500mm.', 'Bongo', 0.7),
            entity('tfc:grouse', 'The grouse spawns at any $(l:core_mechanics/climate#temperature)temperature$() below 13°C and above -12°C, and $(l:core_mechanics/climate#rainfall)rainfall$() between 150 and 400mm.'),
            entity('tfc:pheasant', 'The pheasant spawns in forests at any $(l:core_mechanics/climate#temperature)temperature$() below 17°C and above -5°C, and $(l:core_mechanics/climate#rainfall)rainfall$() between 100 and 300mm.'),
            entity('tfc:turkey', 'The turkey spawns in forests at any $(l:core_mechanics/climate#temperature)temperature$() below 17°C and above 0°C, and $(l:core_mechanics/climate#rainfall)rainfall$() between 250 and 450mm.'),
            entity('tfc:peafowl', 'The peafowl spawns in forests at any $(l:core_mechanics/climate#temperature)temperature$() above 14°C, and $(l:core_mechanics/climate#rainfall)rainfall$() between 190 and 500mm.', 'Peafowl', 0.8),
            entity('tfc:armadillo', 'The armadillo sheds scutes every 30 hours. It can be found at any $(l:core_mechanics/climate#temperature)temperature$() above 12°C, and $(l:core_mechanics/climate#rainfall)rainfall$() between 100 and 400mm.', 'Armadillo', 0.7),
            empty(),
            page_break(),
            ...
            entity('tfc:penguin', 'The penguin spawns on only the coldest beaches, ice sheet edges, and sea ice with $(l:core_mechanics/climate#temperature)temperature$() of at most -14°C and $(l:core_mechanics/climate#rainfall)rainfall$() of at least 75mm.', 'Penguin'),
            entity('tfc:leopard_seal', 'The Leopard Seal spawns on cold beaches, ice sheet edges, and sea ice with $(l:core_mechanics/climate#temperature)temperatures$() of at most -9°C and $(l:core_mechanics/climate#rainfall)rainfall$() of at least 105mm.', 'Leopard Seal'),
            entity('tfc:turtle', 'The sea turtle likes warm water. It spawns in $(l:core_mechanics/climate#temperature)temperature$() of at least 21°C and $(l:core_mechanics/climate#rainfall)rainfall$() of at least 250mm.', 'Sea Turtle'),
            empty(),
            page_break(),
            ...
            entity('tfc:cod', 'Cod prefer colder oceans, $(l:core_mechanics/climate#temperature)temperature$() at most 18°C. They can be fished.', 'Cod'),
            entity('tfc:pufferfish', 'Pufferfish live in any ocean with at least a $(l:core_mechanics/climate#temperature)temperature$() of 10°C.', 'Pufferfish'),
            entity('tfc:jellyfish', 'Jellyfish live in warmer oceans, with a $(l:core_mechanics/climate#temperature)temperature$() of at least 18°C.', 'Jellyfish'),
            entity('tfc:tropical_fish', 'Tropical fish prefer warmer oceans, with a $(l:core_mechanics/climate#temperature)temperature$() of at least 18°C.', 'Tropical Fish'),
            entity('tfc:salmon', 'Salmon spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least -8°C and at most 12°C and with rainfall of at least 250 mm.', 'Salmon'),
            entity('tfc:rainbow_trout', 'Rainbow Trout spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least -12°C and at most 10°C and with rainfall of at least 150 mm.', 'Rainbow Trout'),
            entity('tfc:lake_trout', 'Lake Trout spawn in any lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least -5°C and at most 15°C and with rainfall of at least 250 mm.', 'Lake Trout'),
            entity('tfc:largemouth_bass', 'Largemouth Bass spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least -14°C and at most 16°C and with rainfall of at least 200 mm.', 'Largemouth Bass'),
            entity('tfc:smallmouth_bass', 'Smallmouth Bass spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least -14°C and at most 16°C and with rainfall of less than 300 mm.', 'Smallmouth Bass'),
            entity('tfc:crappie', 'Crappie spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least -10°C and at most 20°C.', 'Crappie'),
            entity('tfc:bluegill', 'Bluegill spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least -10°C and at most 15°C.', 'Bluegill'),
            entity('tfc:northern_pike', 'Northern Pike spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least -10°C and at most 26°C with rainfall between 150 mm and 400 mm.', 'Northern Pike'),
            entity('tfc:peacock_bass', 'Peacock Bass spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least 12°C and at most 25°C with rainfall between 200 mm and 400 mm.', 'Peacock Bass'),
            entity('tfc:arctic_char', 'Arctic Char spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least -20°C and at most -8°C with rainfall between 150mm and 400 mm.', 'Arctic Char'),
            entity('tfc:muksun', 'Muksun spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least -20°C and at most -10°C with rainfall of at least 250 mm.', 'Muksun'),
            entity('tfc:burbot', 'Burbot spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least -16°C and at most -9°C with rainfall less than 350 mm.', 'Burbot'),
            entity('tfc:tilapia', 'Tilapia spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least 10°C and at most 32°C with rainfall less than 300 mm.', 'Tilapia'),
            entity('tfc:spotted_gudgeon', 'Spotted Gudgeon spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least 6°C and at most 24°C with rainfall less than 250 mm.', 'Spotted Gudgeon'),
            entity('tfc:pacu', 'Pacu spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least 20°C and at most 35°C with rainfall above 200 mm.', 'Pacu'),
            entity('tfc:red_piranha', 'Red Piranha spawn in any river or lake with a $(l:core_mechanics/climate#temperature)temperature$() of at least 22°C and at most 35°C with rainfall above 300 mm.', 'Red Piranha'),
            ...
            entity('tfc:isopod', 'Isopods spawn in deeper sections of oceans of $(l:core_mechanics/climate#temperature)temperature$() at most 14°C.', 'Isopod'),
            entity('tfc:lobster', 'Lobster spawn in any ocean that is at most of a $(l:core_mechanics/climate#temperature)temperature$() of 21°C.', 'Lobster'),
            entity('tfc:crayfish', 'Crayfish are like lobster, but spawn in rivers and lakes. They need a $(l:core_mechanics/climate#temperature)temperature$() of at least 5°C and a $(l:core_mechanics/climate#rainfall)rainfall$() of at least 125mm.', 'Crayfish'),
            entity('tfc:horseshoe_crab', 'Horseshoe crabs spawn in oceans of moderate climate, $(l:core_mechanics/climate#temperature)temperature$() between 10 and 21°C and with a $(l:core_mechanics/climate#rainfall)rainfall$() of at most 400mm.', 'Horseshoe Crab'),
            page_break(),
            ...
            entity('tfc:orca', 'Orca whales live in deep oceans with $(l:core_mechanics/climate#temperature)temperature$() of at most 19°C and $(l:core_mechanics/climate#rainfall)rainfall$() of at least 100mm.', 'Orca', scale=0.25),
            entity('tfc:dolphin', 'Dolphins live in deep oceans with $(l:core_mechanics/climate#temperature)temperature$() of at least 10°C and $(l:core_mechanics/climate#rainfall)rainfall$() of at least 200mm.', 'Dolphin', scale=0.4),
            entity('tfc:manatee', 'Manatees live in any warm lake, with $(l:core_mechanics/climate#temperature)temperature$() of at least 20°C and $(l:core_mechanics/climate#rainfall)rainfall$() of at most 300mm.', 'Manatee', scale=0.25),
    ...
    book.category('food', 'Food and Agriculture', 'Everything to know about farming crops and raising animals.', 'tfc:food/maize_bread_jam_sandwich', is_sorted=True, entries=(
        ...
        entry('decay', 'Preservation', 'minecraft:rotten_flesh', pages=(
            ...
            heat_recipe('tfc:heating/food/cooked_mutton', 'Instead, a $(l:getting_started/firepit)Firepit$() or a $(l:food/grill)Grill$() can even provide a buff for using it! For example, cooking mutton (pictured above) in a $(thing)Firepit$() will increase its lifetime by 1.33x, and cooking in a $(thing)Grill$() will increase its lifetime by 1.66x!'),
    ...
    book.category('mechanics', 'Miscellaneous', 'Advanced and miscellaneous sections of the tech tree.$(br2)$(br)$(bold)Note:$() you can search entries simply by starting to type anywhere!', 'tfc:metal/helmet/blue_steel', entries=(
        ...
        entry('gems', 'Gems', 'tfc:gem/opal', pages=(
            ...
            text('Through $(l:metalworking/sluices)Sluicing$() and $(l:getting_started/panning)Panning$(), $(thing)Uncut Gems$() can be obtained. The gem that can be obtained with the sluice is tied to the rock type of the deposit being processed.'),
        ...
        entry('lamps', 'Lamps', 'tfc:metal/lamp/bismuth_bronze', pages=(
            ...
            block_spotlight('Lava Lamps', text_content='Lava will keep burning forever, but can only be held in a $(l:metalworking/steel#blue_steel)Blue Steel$() lamp.', block='tfc:metal/lamp/blue_steel[lit=true]'),
...
def detail_crop(crop: str) -> str:
    ...
    string= '$(bold)$(l:core_mechanics/climate#temperature)Temperature$(): %d - %d °C$(br)$(bold)$(l:food/hydration)Hydration$(): %d - %d %%$(br)$(bold)Category$(): %s$(br)$(br)' % (data.min_temp_growth, data.max_temp_growth, data.min_hydration, data.max_hydration, data.category.title())
    if nitrogen < 0:
