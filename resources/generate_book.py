...
def make_book(rm: ResourceManager, i18n: I18n, local_instance: bool = False, reverse_translate: bool = False):
    ...
    book.category('the_world', 'The World', 'All about the natural world around you.', 'tfc:grass/loam', is_sorted=True, entries=(
        ...
        entry('wild_animals', 'Wild Animals', 'tfc:medium_raw_hide', pages=(
            ...
            entity('tfc:boar', 'The boar spawns in plains with $(l:the_world/climate#temperature)temperature$() below 25°C and above -5°C, and $(l:the_world/climate#rainfall)rainfall$() between 130 and 400mm.', 'Boar'),
            ...
            entity('tfc:deer', 'The deer spawns at any $(l:the_world/climate#temperature)temperature$() below 25°C and above -15°C, and $(l:the_world/climate#rainfall)rainfall$() between 130 and 400mm.'),
            entity('tfc:moose', 'The moose spawns at any $(l:the_world/climate#temperature)temperature$() below 10°C and above -15°C, and $(l:the_world/climate#rainfall)rainfall$() between 150 and 300mm.'),
            ...
            entity('tfc:turkey', 'The turkey spawns at any $(l:the_world/climate#temperature)temperature$() below 17°C and above 0°C, and $(l:the_world/climate#rainfall)rainfall$() between 250 and 450mm.'),
            empty(),
            page_break(),
    ...
    book.category('mechanics', 'Advanced Mechanics', 'Advanced sections of the tech tree, from the first pickaxe, all the way to colored steel.$(br2)$(br)$(bold)Note:$() you can search entries simply by starting to type anywhere!', 'tfc:metal/axe/red_steel', entries=(
        ...
        entry('mechanical_power', 'Mechanical Power', 'tfc:wood/water_wheel/oak', pages=(
            ...
            crafting('tfc:crafting/wood/oak_encased_axle', text_contents='Axles can also be crafted $(thing)Encased$(). These can either be placed by themselves, or on top of existing axles.$(br2)However, in order to transfer power further, you will need a $(l:mechanics/mechanical_power#gearbox)Gear Box$()', title='Gear Boxes').link('#tfc:gear_boxes'),
            ...
            text('In order to use a gearbox, its sides must be configured. $(item)$(k:key.use)$() while holding a $(thing)Hammer$() on any face of the gearbox to enable input/output through that face.$(br2)Note that due to their internal structure, gear boxes can only faces enabled on two different axes of rotation at the same time.'),
            ...
            two_tall_block_spotlight('', 'A $(thing)Quern$() connected to an $(l:mechanics/mechanical_power#axle)Axle$().', 'tfc:quern[has_handstone=true]', 'tfc:wood/axle/oak[axis=y]'),
        )),
