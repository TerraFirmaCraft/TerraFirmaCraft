...
def generate(rm: ResourceManager):
    ...
    rm.placed_feature('alfisol_disc', 'tfc:alfisol_disc', decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate(max_temp=20, min_forest=3))
    ...
    rm.placed_feature('podzol_disc', 'tfc:podzol_disc', decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate(max_temp=20, min_forest=3))
    ...
    configured_plant_patch_feature(rm, ('plant', 'bird_nest_fern'), plant_config('tfc:plant/bird_nest_fern[age=1,stage=1]', 6, 15, 100), decorate_chance(5), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate(17.6, 40, 260, 500, -0.45, 0.45, False, 1, 4, -64, 320))
    ...
    configured_plant_patch_feature(rm, ('plant', 'silver_bromeliad'), plant_config('tfc:plant/silver_bromeliad[age=1,stage=1]', 3, 15, 10), decorate_chance(5), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate(21.2, 28.4, 25, 110, -1, 1, False, 0, 3, -64, 320))
    ...
    configured_plant_patch_feature(rm, ('plant', 'tank_bromeliad'), plant_config('tfc:plant/tank_bromeliad[age=1,stage=1]', 6, 15, 50), decorate_chance(5), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate(17.6, 26.6, 320, 500, -0.4, 0.4, False, 2, 4, -64, 320))
    ...
    configured_patch_feature(rm, 'sticks_shore', patch_config('tfc:groundcover/stick[fluid=empty]', 1, 15, 18, True), decorate_chance(2), decorate_square(), decorate_climate_120(-50, 50, 50, 500), extra_singular_decorators=[decorate_intertidal(1, 10)])
    configured_patch_feature(rm, 'seaweed', patch_config('tfc:groundcover/seaweed[fluid=empty]', 1, 15, 8, True), decorate_chance(5), decorate_square(), decorate_climate_120(-20, 50, 150, 500))
    configured_patch_feature(rm, 'tideline_seaweed', patch_config('tfc:groundcover/seaweed[fluid=empty]', 1, 15, 5, True), decorate_count(2), decorate_square(), decorate_climate_120(-20, 50, 150, 500), extra_singular_decorators=[decorate_intertidal(1, 1)])
    configured_patch_feature(rm, 'guano', patch_config('tfc:groundcover/guano[fluid=empty]', 1, 10, 10), decorate_chance(15), decorate_square(), decorate_climate_120(-30, 10, 100, 500), decorate_on_top_of('tfc:creeping_stone_plantable_on'), extra_singular_decorators=[decorate_intertidal(0, 512)])
...
def forest_config(rm: ResourceManager, min_water: float, max_water: float, min_temp: float, max_temp: float, min_rain_var: float, max_rain_var: float, isAbsolute: bool, tree: str, old_growth: bool, old_growth_chance: int = None, spoiler_chance: int = None, krum: bool = False, floating: bool = None, podzol: bool = False, alfisol: bool = False):
    cfg = {
        ...
        'soil_disc': 'tfc:alfisol_disc' if alfisol else 'tfc:podzol_disc' if podzol else None,
