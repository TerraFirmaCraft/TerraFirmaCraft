...
def generate(rm: ResourceManager):
    ...
    for block in ('packed', 'blue'):
        ...
        rm.placed_feature('iceberg_%s' % block, 'tfc:iceberg_%s' % block, decorate_chance(14), decorate_square(), decorate_climate_120(max_temp=-23))
        rm.placed_feature('iceberg_%s_rare' % block, 'tfc:iceberg_%s_rare' % block, decorate_chance(30), decorate_square(), decorate_climate_120(max_temp=-18))
    ...
    configured_plant_patch_feature(rm, ('plant', 'bird_nest_fern'), plant_config('tfc:plant/bird_nest_fern[age=1,stage=1]', 6, 15, 100, no_solid_neighbors=True), decorate_chance(5), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate_121(17.6, 40, 260, 500, -0.45, 0.45, False, 1, 4, -64, 320))
    ...
    configured_plant_patch_feature(rm, ('plant', 'silver_bromeliad'), plant_config('tfc:plant/silver_bromeliad[age=1,stage=1]', 3, 15, 10, no_solid_neighbors=True), decorate_chance(5), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate_121(21.2, 28.4, 25, 110, -1, 1, False, 0, 3, -64, 320))
    ...
    configured_plant_patch_feature(rm, ('plant', 'tank_bromeliad'), plant_config('tfc:plant/tank_bromeliad[age=1,stage=1]', 6, 15, 50, no_solid_neighbors=True), decorate_chance(5), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate_121(17.6, 26.6, 320, 500, -0.4, 0.4, False, 2, 4, -64, 320))
