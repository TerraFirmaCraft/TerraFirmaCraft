...
def generate(rm: ResourceManager):
    ...
    forest_config(rm, 350, 500, -11.2, 5, -0.65, 1, False, 'aspen', True, old_growth_chance=1, krum=True)
    ...
    forest_config(rm, 270, 500, -11.2, 8.6, -1, 0.1, False, 'douglas_fir', True, krum=True)
    ...
    forest_config(rm, 90, 320, -5.8, 12.2, -1, 0.75, False, 'pine', True, old_growth_chance=1, krum=True)
    ...
    forest_config(rm, 220, 500, -13, -4, -1, 1, False, 'spruce', True, krum=True)
    forest_config(rm, 330, 500, -4, 17.6, -0.15, 1, False, 'sycamore', True)
    forest_config(rm, 100, 285, -11.2, 3.2, -0.45, 0.65, False, 'white_cedar', True, krum=True)
    ...
    configured_plant_patch_feature(rm, ('plant', 'bluegrass'), plant_config('tfc:plant/bluegrass[age=1,stage=1]', 1, 15, 64, limit_density=True), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate(-0.4, 14., 110, 280))
    configured_plant_patch_feature(rm, ('plant', 'bromegrass'), plant_config('tfc:plant/bromegrass[age=1,stage=1]', 1, 15, 64, limit_density=True), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate(6.8, 21.2, 140, 360))
    configured_plant_patch_feature(rm, ('plant', 'fountain_grass'), plant_config('tfc:plant/fountain_grass[age=1,stage=1]', 1, 15, 64, limit_density=True), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate(3.2, 26.6, 75, 150))
    configured_plant_patch_feature(rm, ('plant', 'manatee_grass'), plant_config('tfc:plant/manatee_grass[age=1,stage=1]', 1, 15, 64, water_plant=True), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate(14., 40, 250, 500))
    configured_plant_patch_feature(rm, ('plant', 'orchard_grass'), plant_config('tfc:plant/orchard_grass[age=1,stage=1]', 1, 15, 64, limit_density=True), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate(-14.8, 12.2, 75, 300))
    configured_plant_patch_feature(rm, ('plant', 'ryegrass'), plant_config('tfc:plant/ryegrass[age=1,stage=1]', 1, 15, 64, limit_density=True), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate(-11.2, 40, 150, 320))
    ...
    configured_plant_patch_feature(rm, ('plant', 'timothy_grass'), plant_config('tfc:plant/timothy_grass[age=1,stage=1]', 1, 15, 64, limit_density=True), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate(-9.4, 17.6, 289, 500))
    configured_plant_patch_feature(rm, ('plant', 'raddia_grass'), plant_config('tfc:plant/raddia_grass[age=1,stage=1]', 1, 15, 64, limit_density=True), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate(19.4, 40, 330, 500))
