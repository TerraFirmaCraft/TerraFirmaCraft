...
def generate(rm: ResourceManager):
    ...
    configured_plant_patch_feature(rm, ('plant', 'bear_grass'), plant_config('tfc:plant/bear_grass[age=1,stage=1,part=lower]', 1, 15, 10, tall_plant=True), decorate_chance(5), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate_121(-2.2, -13, 380, 500, -1, 1, False, 0, 1, 85, 300))
    ...
    configured_plant_patch_feature(rm, ('plant', 'edelweiss'), plant_config('tfc:plant/edelweiss[age=1,stage=1]', 1, 10, 10), decorate_chance(5), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate_121(-16.6, 3.2, 200, 450, -0.4, 0.4, False, 2, 3, 95, 300))
    ...
    configured_plant_patch_feature(rm, ('plant', 'kinnikinnick'), plant_config('tfc:plant/kinnikinnick[age=1,stage=1]', 1, 15, 60), decorate_chance(5), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate_121(-18.4, -13, 210, 500, -1, 1, False, 0, 4, 50, 115))
    ...
    configured_plant_patch_feature(rm, ('plant', 'ramunda'), plant_config('tfc:plant/ramunda[age=1,stage=1]', 1, 15, 10), decorate_chance(5), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate_121(-18.4, -0.4, 0, 190, -0.25, 0.5, False, 0, 1, 90, 315))
    ...
    configured_plant_patch_feature(rm, ('plant', 'shawiash'), plant_config('tfc:plant/shawiash[age=1,stage=1]', 3, 12, 60), decorate_chance(5), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate_121(-16.6, -2.2, 250, 500, -1, 0.25, False, 0, 2, 95, 300))
    ...
    configured_plant_patch_feature(rm, ('plant', 'yellow_saxifrage'), plant_config('tfc:plant/yellow_saxifrage[age=1,stage=1]', 1, 10, 40), decorate_chance(5), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate_121(-16.6, -4, 160, 500, -1, 0.3, False, 0, 3, -64, 320))
