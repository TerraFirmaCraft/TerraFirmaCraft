...
def generate(rm: ResourceManager):
    ...
    biome(rm, 'tower_karst_plains', 'plains', lake_features=False)
    biome(rm, 'burren_plains', 'plains', lake_features=False)
    biome(rm, 'shilin_plains', 'plains', lake_features=False)
    biome(rm, 'doline_plains', 'plains', hot_spring_features=True, lake_features=False)
    biome(rm, 'cenote_plains', 'plains', hot_spring_features=True, lake_features=False)
    biome(rm, 'tower_karst_canyons', 'plains', lake_features=False)
    biome(rm, 'doline_canyons', 'plains', hot_spring_features=True, lake_features=False)
    biome(rm, 'cenote_canyons', 'plains', hot_spring_features=True, lake_features=False)
    biome(rm, 'shilin_canyons', 'plains', lake_features=False)
    biome(rm, 'tower_karst_hills', 'plains', lake_features=False)
    biome(rm, 'burren_drumlins', 'plains', lake_features=False)
    biome(rm, 'shilin_hills', 'plains', lake_features=False)
    biome(rm, 'doline_hills', 'plains', hot_spring_features=True, lake_features=False)
    biome(rm, 'cenote_hills', 'plains', hot_spring_features=True, lake_features=False)
    biome(rm, 'tower_karst_highlands', 'plains', lake_features=False)
    biome(rm, 'burren_badlands_tall', 'mesa', lake_features=False)
    biome(rm, 'shilin_highlands', 'plains', lake_features=False)
    biome(rm, 'doline_highlands', 'plains', hot_spring_features=True, lake_features=False)
    biome(rm, 'cenote_highlands', 'plains', hot_spring_features=True, lake_features=False)
    biome(rm, 'extreme_doline_plateau', 'extreme_hills', lake_features=False)
    biome(rm, 'burren_plateau', 'extreme_hills', lake_features=False)
    biome(rm, 'shilin_plateau', 'extreme_hills', lake_features=False)
    biome(rm, 'doline_plateau', 'extreme_hills', hot_spring_features=True, lake_features=False)
    biome(rm, 'cenote_plateau', 'extreme_hills', hot_spring_features=True, lake_features=False)
    biome(rm, 'tower_karst_lake', 'swamp', lake_features=False)
    biome(rm, 'tower_karst_bay', 'swamp', lake_features=False)
    biome(rm, 'extreme_doline_mountains', 'extreme_hills', lake_features=False)
    biome(rm, 'burren_badlands', 'mesa', lake_features=False)
    biome(rm, 'doline_rolling_hills', 'plains', hot_spring_features=True, lake_features=False)
    biome(rm, 'cenote_rolling_hills', 'plains', hot_spring_features=True, lake_features=False)
    ...
    rm.biome_tag('burrens', 'tfc:burren_plains', 'tfc:burren_drumlins', 'tfc:burren_badlands', 'tfc:burren_badlands_tall', 'tfc:burren_plateau')
