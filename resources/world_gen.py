...
def generate(rm: ResourceManager):
    ...
    for crop, crop_data in CROPS.items():
        ...
        rm.placed_feature(patch_feature, patch_feature, decorate_chance(40), decorate_square(), decorate_climate(crop_data.min_temp, crop_data.max_temp, crop_data.min_rain, crop_data.max_rain, min_forest=crop_data.min_forest, max_forest=crop_data.max_forest))
