...
def generate(rm: ResourceManager):
    ...
    configured_plant_patch_feature(rm, ('plant', 'duckweed'), plant_config('tfc:plant/duckweed[age=1,stage=1]', 1, 7, 100), decorate_chance(5), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate_121(12.2, 40, 0, 500, -1, 1, False, 0, 4, -64, 320))
    ...
    configured_plant_patch_feature(rm, ('plant', 'heather'), plant_config('tfc:plant/heather[age=1,stage=1]', 1, 10, 20, no_solid_neighbors=True), decorate_chance(5), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate_121(-4.8, 6.1, 180, 380, -1, 1, False, 0, 2, -64, 320))
    ...
    configured_plant_patch_feature(rm, ('plant', 'prickly_pear'), plant_config('tfc:plant/prickly_pear[age=1,stage=1]', 1, 15, 10, no_solid_neighbors=True), decorate_chance(5), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate_121(-4, 21.2, 55, 155, -0.4, 0.7, False, 1, 3, -64, 320))
    configured_plant_patch_feature(rm, ('plant', 'prickly_pear_purple'), plant_config('tfc:plant/prickly_pear_purple[age=1,stage=1]', 1, 15, 10, no_solid_neighbors=True), decorate_chance(5), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate_121(8.6, 14., 40, 140, -0.4, 0.7, False, 1, 3, -64, 320))
    ...
    configured_plant_patch_feature(rm, ('plant', 'silver_spurflower'), plant_config('tfc:plant/silver_spurflower[age=1,stage=1]', 1, 10, 10), decorate_chance(5), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate_121(15.8, 24.8, 230, 400, -0.55, 1, False, 1, 2, -64, 320))
    ...
    configured_plant_patch_feature(rm, ('plant', 'toquilla_palm'), plant_config('tfc:plant/toquilla_palm[age=1,stage=1,part=lower]', 1, 15, 10, tall_plant=True, no_solid_neighbors=True, limit_density=True), decorate_chance(5), decorate_square(), decorate_heightmap('world_surface_wg'), decorate_climate_121(17.6, 40, 250, 500, -0.85, 0.85, False, 2, 4, -64, 320))
