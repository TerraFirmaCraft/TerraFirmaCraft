...
def generate(rm: ResourceManager):
    ...
    forest_config(rm, 350, 500, -18, 5, 'aspen', True, old_growth_chance=1)
    forest_config(rm, 125, 310, -11, 7, 'birch', False, old_growth_chance=1)
    forest_config(rm, 0, 180, 12, 35, 'blackwood', True)
    forest_config(rm, 180, 370, -4, 17, 'chestnut', True)
    ...
    configured_placed_feature(rm, ('tree', 'birch_large'), 'tfc:random_tree', random_config('birch', 6, trunk=[6, 9, 1], place=tree_placement_config(1, 10)))
    ...
    configured_placed_feature(rm, ('tree', 'chestnut'), 'tfc:random_tree', random_config('chestnut', 12, 1, trunk=[2, 3, 1], place=tree_placement_config(1, 5)))
    ...
    configured_placed_feature(rm, ('tree', 'hickory'), 'tfc:random_tree', random_config('hickory', 5, trunk=[1, 2, 1], place=tree_placement_config(1, 5)))
    ...
    configured_placed_feature(rm, ('tree', 'mangrove'), 'tfc:random_tree', random_config('willow', 7, place=tree_placement_config(1, 3, True), roots=root_config(4, 2, 5)))
    configured_placed_feature(rm, ('tree', 'mangrove_dead'), 'tfc:random_tree', random_config('willow', 3, 1, '_dead', place=tree_placement_config(2, 3, True, True), roots=root_config(4, 2, 5)))
    ...
    configured_plant_patch_feature(rm, ('plant', 'lily_of_the_valley'), plant_config('tfc:plant/lily_of_the_valley[age=1,stage=1]', 1, 10, 10), decorate_chance(5), decorate_square(), decorate_climate(-24, 14, 180, 415, min_forest='edge', max_forest='old_growth'))
    ...
    configured_plant_patch_feature(rm, ('plant', 'beachgrass'), plant_config('tfc:plant/beachgrass[age=1,stage=1]', 1, 15, 28), decorate_chance(3), decorate_square(), decorate_climate(-8, 30, 190, 500))
